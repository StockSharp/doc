...
5. 然后，在 **常规** 选项卡中单击 [K线](../working_with_data/view_and_export/candles.md) 按钮，选择生成的交易品种和数据时间段，在 **构建来源** 字段中选择 **复合元素**，再单击 ![hydra find](../../../images/hydra_find.png) 按钮。![HydraGluingTrades](../../../images/hydragluingtrades.png)
