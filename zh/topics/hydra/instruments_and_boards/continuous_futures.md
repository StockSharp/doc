...
2. 创建连续期货时，需要指定名称并添加合约。
   ...
   添加合约有两种方式。
   - 单击 ![Hydra 添加按钮](../../../images/hydra_add.png) 按钮手动添加。![HydraGluingCSCustom](../../../images/hydragluingcscustom.png)
   - 将合约名称设为其前两个字母（例如 RI），然后单击 **自动** 按钮，数据库中找到的所有相关交易品种都会被添加。![HydraGluingCSAuto](../../../images/hydragluingcsauto.png)
...
5. 然后，在 **常规** 选项卡中单击 [K线](../working_with_data/view_and_export/candles.md) 按钮，选择生成的交易品种和数据时间段，在 **构建来源** 字段中选择 **复合元素**，再单击 ![Hydra 查找按钮](../../../images/hydra_find.png) 按钮。![HydraGluingTrades](../../../images/hydragluingtrades.png)
