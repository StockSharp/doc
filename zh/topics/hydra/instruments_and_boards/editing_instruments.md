...
如有需要，还可以批量编辑一组交易品种。选择一组交易品种，然后单击 ![hydra edit](../../../images/hydra_edit.png) 按钮。
...
如果所有选中交易品种的某个字段具有相同值，界面将显示该值；如果值不同，该字段将留空。例如，两个交易品种的 Price Step 都为 1，但其中一个的手数为 10，另一个为 100，则 Price Step 字段会显示 1，而 Volume Step 字段会留空。
