...
3. 假设需要下载满足以下条件的交易品种：APPLE 股票，货币为美元。请按下图设置交易品种参数，然后单击 **OK**。![hydra choose securitiy 01](../../../images/hydra_choose_securitiy_01.png)
   ...
   随后，[Hydra](../../hydra.md) 会下载符合指定条件的所有交易品种。![hydra choose securitiy 02](../../../images/hydra_choose_securitiy_02.png)![hydra choose securitiy 03](../../../images/hydra_choose_securitiy_03.png)
