...
要添加断点，请选择模块，然后单击 ![Designer Debug 01](../../../../images/designer_debug_01.png)**添加断点** 按钮。添加断点后，模块会以红色圆圈标记：
...
单击 ![Designer Debug 01](../../../../images/designer_debug_01.png)**断点** 按钮后，会打开显示全部断点的窗口。可以为每个断点设置附加触发条件。例如，可以要求逻辑信号值为 **True**。在这种情况下，仅当信号值为 **True** 时，断点才会中止执行。
