...
3. **实盘** 文件夹包含已添加用于交易的策略。正在运行的策略以图标 ![Designer Panel Circuits 02](../../../images/designer_panel_circuits_02.png) 标记，已停止的策略以图标 ![Designer Panel Circuits 03](../../../images/designer_panel_circuits_03.png) 标记。有关如何向 **实盘** 文件夹添加并启动策略，请参阅[实盘交易](../live_execution/getting_started.md)章节。
