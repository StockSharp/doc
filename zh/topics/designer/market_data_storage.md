...
要打开 **Market data** 选项卡，请切换到 **Common** 选项卡，然后单击 **Market data** 按钮。**Market data** 区域分为三个部分。左侧区域列出曾经连接过的所有数据源所提供的全部交易品种。中间区域包含当前使用的交易品种，可用于下载历史数据或查看已下载的数据。右侧区域显示中间区域所选交易品种的可用数据，也可以在此为选中的交易品种下载数据。
