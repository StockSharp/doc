...
要添加新策略，可以在 **常规** 选项卡中单击 **添加** 按钮 ![Designer 线路面板 01](../../../../images/designer_panel_circuits_01_button.png)，然后选择 **策略**。也可以在 **策略图** 面板中右键单击 **策略** 文件夹，再在下拉菜单中单击 **添加** 按钮 ![Designer 线路面板 01](../../../../images/designer_panel_circuits_01_button.png)：
