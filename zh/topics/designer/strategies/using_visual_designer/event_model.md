...
例如，[Order book](elements/market_depths/order_book.md) 模块会生成市场深度变化事件，无法预先知道该变化将在何时发生。在 [Order book](elements/market_depths/order_book.md) 模块与 [Converter](elements/converters/converter.md) 模块之间创建连接线后，就订阅了市场深度变化事件，以便由 [Converter](elements/converters/converter.md) 模块进行后续处理，依此类推：
