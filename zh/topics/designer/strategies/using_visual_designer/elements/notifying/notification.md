...
当数据到达输入端口时，该模块会发送通知。传入值通过 `ToString` 转换为文本。可以连接 [Variable](../common/variable.md) 来发送固定文本，连接成交或蜡烛数据流来查看其详细信息，也可以使用 [String format](string_format.md) 和 [String concat](string_concat.md) 模块生成自定义消息。
