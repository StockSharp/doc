...
单击交易品种面板上的 **Add** 按钮 ![Designer Creation tool 00](../../images/designer_creation_tool_00.png)，添加希望监控的交易品种。该面板会显示最优价格数据。有关交易品种面板的详细信息，请参阅[交易品种](user_interface/components/instruments.md)。

![Terminal Quick start 02](../../images/terminal_quick_start_02.png)

在订单簿中单击 **Settings** 按钮 ![Designer Schedule 01](../../images/designer_schedule_01.png)，会出现一个设置面板，可以在其中指定用于交易的 **Instrument** 和 **Portfolio**，也可以调整订单簿深度。有关订单簿操作的详细信息，请参阅[订单簿](user_interface/components/order_book.md)。

![Terminal Quick start 03](../../images/terminal_quick_start_03.png)

现在可以登记最初的几笔订单。既可以单击 **Buy/Sell** 按钮登记订单，也可以单击订单簿中 **Bid/Offer** 列的单元格。订单面板会显示您的全部订单。右键单击某个订单时，会出现一个面板，可用于提交新订单、撤销订单或修改所选订单。有关订单面板的详细信息，请参阅[订单](user_interface/components/orders.md)。

![Terminal Quick start 04](../../images/terminal_quick_start_04.png)

在 Trades 面板中，可以按交易品种查看成交。有关 Trades 面板的详细信息，请参阅[成交](user_interface/components/trades.md)。
