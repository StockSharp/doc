...
要向图表添加新元素，请右键单击图表区域中的任意位置并选择所需元素。可选元素包括蜡烛图、指标、订单和自有成交。

单击 ![Designer Schedule 01](../../../../images/designer_schedule_01.png) 可打开图形元素的设置。
...
在图形元素设置中，可以选择所需的图表样式，例如日本蜡烛图、柱状图、箱形图、聚类轮廓图等。

![Designer Schedule 04](../../../../images/designer_schedule_04.png)

对于箱形图，还可以对蜡烛图进行分组。分组顺序通过“第二时间周期倍数”和“第三时间周期倍数”字段设置。
