...
要添加新的图表区域，请单击 ![Designer 添加按钮 00](../../../../images/designer_creation_tool_00.png) 按钮。

要向图表添加新元素，请右键单击图表区域中的任意位置并选择所需元素。可选元素包括K线、指标、订单和自有成交。

单击 ![Designer 图形元素 00](../../../../images/designer_schedule_00.png)，然后单击 ![Designer 图形元素 01](../../../../images/designer_schedule_01.png) 可打开图形元素的设置。
