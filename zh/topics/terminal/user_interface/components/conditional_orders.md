...
![Terminal 条件订单面板 01](../../../../images/terminal_orders_conditional_panel_01.png)

单击 **订单登记** 按钮后会出现一个窗口。要登记新的条件订单，请填写该窗口并单击 **发送** 按钮。

![Terminal 条件订单面板 02](../../../../images/terminal_orders_conditional_panel_02.png)

单击 **修改订单** 按钮后会出现一个窗口。要修改条件订单，请完成所需更改并单击 **发送** 按钮。

![Terminal 条件订单面板 03](../../../../images/terminal_orders_conditional_panel_03.png)
