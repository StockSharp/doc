...
| 控件 | 类 | 标识符 |
|---|---|---|
| [活动订单](trading_controls/active_orders.md) | `ActiveOrdersWidget` | `activeOrders` |
| [持仓](trading_controls/positions.md) | `PositionsWidget` | `positions` |
| [成交历史](trading_controls/trade_history.md) | `TradeHistoryWidget` | `tradeHistory` |
| [自选交易品种列表](trading_controls/watchlist.md) | `WatchlistWidget` | `watchlist` |
