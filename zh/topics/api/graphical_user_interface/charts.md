...
- [箱形图](charts/box_chart.md) - 一种将数量表示为数字网格的图表。
- [簇状图](charts/cluster_chart.md) - 一种以集群和直方图显示数量的图表。
- [OptionPositionChart](xref:StockSharp.Xaml.Charting.OptionPositionChart) - 一个图形组件，显示相对于标的资产的期权持仓和“希腊字母”。参见[持仓图表](options/position_chart.md)。

此外，[S#](../../api.md) 包含两种用于成交量分析的图表类型：[箱形图](charts/box_chart.md)和[簇状图](charts/cluster_chart.md)。
...
- [JavaScript 图表](../javascript_ui/charts.md)
