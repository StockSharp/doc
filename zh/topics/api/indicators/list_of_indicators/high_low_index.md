...
高低指标（HLI）是一种市场广度指标，通过比较达到新高的工具数量与达到新低的工具数量来分析整体市场活动。这可以用来评估市场的内部强弱。

该指标的主要理念是，健康的市场特征是达到新高的证券数量多于达到新低的证券数量。相反，疲弱的市场则会有更多证券达到新低。
...
1. **数值范围**：
   ...
   - 正值表示达到新高的证券多于达到新低的证券
   - 负值表示达到新低的证券多于达到新高的证券
