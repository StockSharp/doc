...
下面的代码演示如何初始化 [ApexOmniMessageAdapter](xref:StockSharp.ApexOmni.ApexOmniMessageAdapter)，并将其传递给 [Connector](xref:StockSharp.Algo.Connector)。
