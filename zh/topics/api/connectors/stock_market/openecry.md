...
[Adapter初始化 OpenECry](openecry/adapter_initialization_openecry.md)

[多个算法连接](openecry/several_algorithms_connection.md)

[终端与算法同时操作](openecry/simultaneous_terminal_and_algorithm_operation.md)
