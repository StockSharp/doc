...
[连接器配置](trading_economics/configuration_trading_economics.md)

[图形化配置](trading_economics/graphical_configuration_trading_economics.md)

[适配器初始化](trading_economics/adapter_initialization_trading_economics.md)
