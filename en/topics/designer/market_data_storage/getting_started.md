...
To create historical data storage, click the ![Designer Creating a repository of historical data 00](../../../images/designer_creating_repository_of_historical_data_00.png) button on the **Market data** tab. Click ![Designer Creating a repository of historical data 01](../../../images/designer_creating_repository_of_historical_data_01.png) to change the current storage parameters. Click ![Designer Creating a repository of historical data 02](../../../images/designer_creating_repository_of_historical_data_02.png) to delete the current storage from the list of storages.
...
Remote storage may be located on another computer. To configure it, specify the remote storage address and, if required, the login and password.
