...
- **Buffering period** - a parameter that is responsible for the period of sending whole packets to emulate network latency and buffer the work of the exchange core.
