...
- Advanced training - [StockSharp Education](https://stocksharp.com/en/edu/).
- Source code of S# core - [GitHub\/StockSharp](https://github.com/StockSharp/StockSharp).
- Free and paid products - [Shell](https://stocksharp.com/en/store/).
...
- Platform site - [https:\/\/stocksharp.com/en](https://stocksharp.com/en/).
- Blog - [StockSharp Blog](https://stocksharp.com/en/blog/).
- Telegram chat - [Chat](https://stocksharp.com/en/chat/).
