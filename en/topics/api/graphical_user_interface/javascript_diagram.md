...
Then import the ES modules — `import { renderScheme } from '@stocksharp/diagram/embed'` for the read-only embed, or `import { StockSharpDiagram } from '@stocksharp/diagram'` for the [interactive editor](javascript_diagram/editor.md).
...
The same component also runs as a full **editor** — drag elements from a palette, connect ports, edit and delete nodes, undo/redo. See [Interactive editor](javascript_diagram/editor.md) and [Events and API](javascript_diagram/events.md).

## See also

- [Interactive editor](javascript_diagram/editor.md)
- [Events and API](javascript_diagram/events.md)
- [JavaScript charts](charts/javascript_charts.md)
- [Designer](../../designer.md) — the desktop visual strategy editor
- [Diagram repository](https://github.com/StockSharp/Diagram)
