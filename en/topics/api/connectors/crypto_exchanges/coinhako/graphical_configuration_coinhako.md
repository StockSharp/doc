# Graphical Configuration of Coinhako
...
- `CounterCurrencies` - quote currencies requested when markets are polled.
- `PollingInterval` - interval between service polling requests.
