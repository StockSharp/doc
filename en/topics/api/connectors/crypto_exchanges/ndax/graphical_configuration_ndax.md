# Graphical Configuration of NDAX
...
- `Key` - API key.
- `Secret` - API secret.
- `UserId` - user identifier assigned by the service.
- `AccountId` - account identifier assigned by the service.
- `OmsId` - NDAX order management system identifier.
