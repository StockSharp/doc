...
The code below demonstrates how to initialize the [QuickSwapMessageAdapter](xref:StockSharp.QuickSwap.QuickSwapMessageAdapter) and pass it to the [Connector](xref:StockSharp.Algo.Connector).
