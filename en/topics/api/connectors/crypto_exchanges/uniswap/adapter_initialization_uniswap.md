...
The code below demonstrates how to initialize the [UniswapMessageAdapter](xref:StockSharp.Uniswap.UniswapMessageAdapter) and pass it to the [Connector](xref:StockSharp.Algo.Connector).
