...
Available instruments, data depth, transaction permissions, request limits, and service availability are controlled by AscendEX and by the connected account or API plan.

## See also

[Connector configuration](ascendex/configuration_ascendex.md)

[Graphical configuration](ascendex/graphical_configuration_ascendex.md)

[Adapter initialization](ascendex/adapter_initialization_ascendex.md)
