...
The following code shows how to initialize [MiraeSharekhanMessageAdapter](xref:StockSharp.MiraeSharekhan.MiraeSharekhanMessageAdapter) and add it to [Connector](xref:StockSharp.Algo.Connector).
