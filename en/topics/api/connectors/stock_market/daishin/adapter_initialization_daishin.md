...
The following code shows how to initialize [DaishinMessageAdapter](xref:StockSharp.Daishin.DaishinMessageAdapter) and add it to [Connector](xref:StockSharp.Algo.Connector).
