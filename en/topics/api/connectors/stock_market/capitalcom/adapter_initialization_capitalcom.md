...
The following code shows how to initialize [CapitalComMessageAdapter](xref:StockSharp.CapitalCom.CapitalComMessageAdapter) and add it to [Connector](xref:StockSharp.Algo.Connector).
