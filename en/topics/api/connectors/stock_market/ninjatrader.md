...
**NinjaTrader** integrates StockSharp with **NinjaTrader REST and WebSocket APIs** for market data and trading.
...
Before developing trading robots for NinjaTrader, review the links in the [Connectors](../../connectors.md) section.
