...
**Databento** connects StockSharp to the official **Databento Live and Historical APIs**.

The connector supports instrument lookup and real-time and historical market data.
