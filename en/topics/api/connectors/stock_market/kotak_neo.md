...
**Kotak Neo** integrates StockSharp with **Kotak Neo Trade API v2** for market data and trading.
...
Before developing trading robots for Kotak Neo, review the links in the [Connectors](../../connectors.md) section.
