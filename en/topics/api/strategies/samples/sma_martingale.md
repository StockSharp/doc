...
In the [OnStarted2](xref:StockSharp.Algo.Strategies.Strategy.OnStarted2(System.DateTime)) method, SMA indicators are created, candle subscription is set up, and visualization is prepared:
