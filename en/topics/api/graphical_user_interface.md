...
To access the [S#](../api.md) graphical controls in the XAML code you need to define the aliases for the corresponding namespace and to use these aliases in the XAML code. How to do this is shown in the following example:
