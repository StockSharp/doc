...
This topic is designed for traders who develop graphical trading programs via [S\#](../api.md), but not enough familiar with the basics of GUI programming in [.NET](https://en.wikipedia.org/wiki/.NET_Framework).
...
[S\#](../api.md) already has special methods that hide the Dispatcher use and simplify coding: 
