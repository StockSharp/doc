...
- **コネクタとグラフィカルコントロール**: API には、リアルタイムマーケットデータと取引アクセスのための多数の [コネクタ](api/connectors.md) が含まれています。また、プロフェッショナルな取引プラットフォームを構築するためのカスタマイズ可能な [グラフィカルユーザーインターフェイス](api/graphical_user_interface.md) コンポーネントも提供します。
