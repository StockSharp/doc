...
グラフから、ストラテジーで計画したとおり、移動平均の交差で取引が行われていることがわかります。また、注文が複数の約定で充足されていることも確認できます。これは生成された板を使用しているためで、テストの現実性が高まります。注文が複数の約定で充足されていることは、約定テーブル、統計、およびポジションチャートから確認できます。
