...
**チャート** コンポーネントには、ストラテジー内にあるすべての **チャートパネル** キューブが含まれます。たとえば、ストラテジーが 2 つの **チャートパネル** キューブを使用している場合、図のように **チャート** コンポーネントには 2 つのチャートが表示されます。

![Designer グラフィックパネル 04](../../../../images/designer_panel_graphics_04.png)
