...
**ポートフォリオ** パネルは、ポートフォリオの基本データと、それらのポートフォリオの現在ポジションを表示するテーブルです。ポートフォリオまたはポジションをダブルクリックすると、**ポートフォリオ作成** ウィンドウまたは **ポジション作成** ウィンドウが表示され、選択したポートフォリオまたはポジションを編集できます。新しいポートフォリオまたは新しいポジションを作成するには、![Designer Panel Circuits 01](../../../images/designer_panel_circuits_01.png) ボタンをクリックし、ドロップダウン メニューで該当する項目を選択する必要があります。
