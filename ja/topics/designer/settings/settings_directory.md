...
- **Compositions** は、[スキームパネル](../user_interface/schemas.md) の **複合要素** フォルダーにあるすべてのブロックを XML ファイルとして保存します。このディレクトリからファイルを削除すると、対応する **複合要素** が [スキームパネル](../user_interface/schemas.md) の **複合要素** フォルダーから削除されます。これらのファイルを手動で編集しないでください。編集すると、対応する **複合要素** ブロックが破損する可能性があります。
- **LiveStrategies** は、[スキームパネル](../user_interface/schemas.md) の **取引** フォルダーにあるすべてのブロックを XML ファイルとして保存します。このディレクトリからファイルを削除すると、対応するストラテジーが [スキームパネル](../user_interface/schemas.md) の **取引** フォルダーから削除されます。これらのファイルを手動で編集しないでください。編集すると、対応するストラテジーが破損する可能性があります。
- **ログ** には、すべての [Designer](../../designer.md) クラッシュログが含まれ、[Designer](../../designer.md) のトラブルシューティングを簡単にします。
- **SourceCode** は、[スキームパネル](../user_interface/schemas.md) の **ソースコード** フォルダーにあるすべてのブロックを XML ファイルとして保存します。このディレクトリからファイルを削除すると、**ソースコード** ブロックが [スキームパネル](../user_interface/schemas.md) の **ソースコード** フォルダーから削除されます。これらのファイルを手動で編集しないでください。編集すると、対応する **ソースコード** ブロックが破損する可能性があります。
- **戦略** は、[スキームパネル](../user_interface/schemas.md) の **戦略** フォルダーにあるすべてのブロックを XML ファイルとして保存します。このディレクトリからファイルを削除すると、対応するストラテジーがスキームパネルの **戦略** フォルダーから削除されます。これらのファイルを手動で編集しないでください。編集すると、対応するストラテジーが破損する可能性があります。このフォルダーにストラテジーファイルを手動で追加して [Designer](../../designer.md) を再起動すると、そのストラテジーは [スキームパネル](../user_interface/schemas.md) の **戦略** フォルダーに表示されます。
