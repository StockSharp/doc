...
コードエディターのタブは、**Source Code** パネルと **Error List** パネルで構成されています。**Source Code** パネルには C# コードエディター本体があります。上部にはツールバーがあり、**Current Line**、**Line Number** などの強調表示をオンまたはオフにできます。フォントサイズを大きくするには、CTRL+MouseWheel の組み合わせを使用できます。
