...
CurrComparison キューブと PrevComparison キューブでは、**Common** プロパティグループの **Parameters** フラグが設定されています。そのため、これらのキューブのプロパティは複合要素 [クロス](elements/common/crossing.md) のプロパティに取り込まれ、ストラテジースキーマで複合要素を使用するときに指定されます。
