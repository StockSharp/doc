...
**確定** を押すと、**スキーム** パネルの **ストラテジー** フォルダーに新しいストラテジーが表示されます。ワークスペースにはそのストラテジーの新しいタブが表示され、そこへ移動するとリボンの **バックテスト** タブが自動的に開きます。**スキーム** パネルでストラテジーを右クリックすると、ストラテジー名の変更などを行えるメニューが開きます。
