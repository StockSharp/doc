...
![Designer ストラテジーのエクスポート 00](../../../images/designer_export_strategies_00.png)

**エクスポート** を押すと、コンテンツの種類に応じてウィンドウが表示されます。

- [スキーマ](../strategies/using_visual_designer.md) の場合:

  ![Designer ストラテジーのエクスポート 01](../../../images/designer_export_strategies_01.png)
...
- [コード](../strategies/using_code.md) の場合:
  ...
  ![Designer ストラテジーのエクスポート 02](../../../images/designer_export_strategies_02.png)
