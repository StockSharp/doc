...
![Shell リモートマネージャー 00](../../../images/shell_remotemanager_00.png)

表示されるウィンドウで、**ログイン** と **パスワード** を設定します。

![Shell リモートマネージャー 01](../../../images/shell_remotemanager_01.png)

次に、**サーバーモード** を有効にする必要があります。

![Shell リモートマネージャー 02](../../../images/shell_remotemanager_02.png)

これで、別の Shell から Shell に接続できるようになります。

そのためには、**別の Shell** を起動する必要があります。その中で、接続設定に移動します。

![Shell リモートマネージャー 03](../../../images/shell_remotemanager_03.png)

開いたウィンドウで、FIX 接続を設定します。

![Shell リモートマネージャー 04](../../../images/shell_remotemanager_04.png)

次に、接続ボタンを押します。

![Shell リモートマネージャー 05](../../../images/shell_remotemanager_05.png)

接続すると、Shell サーバー内に存在するすべてのストラテジーが Shell クライアントで利用可能になります。

![Shell リモートマネージャー 06](../../../images/shell_remotemanager_06.png)

追加ボタンをクリックすると、取引用に別のストラテジーを追加できます。

![Shell リモートマネージャー 07](../../../images/shell_remotemanager_07.png)

Shell クライアントは複数のサーバーをサポートしているため、ストラテジーを追加する際には左側でサーバーを選択する必要があります。サーバーで利用可能なすべてのストラテジーが右側に表示されます。

![Shell リモートマネージャー 08](../../../images/shell_remotemanager_08.png)

ストラテジーを追加すると、ストラテジー一覧に表示されます。

![Shell リモートマネージャー 09](../../../images/shell_remotemanager_09.png)

ストラテジーを選択すると、右側にストラテジー設定と統計情報のタブが表示されます。

ストラテジー設定を変更した後は、必ず変更を適用ボタンをクリックしてください。そうしないと、変更はストラテジーに適用されません。

![Shell リモートマネージャー 10](../../../images/shell_remotemanager_10.png)

ストラテジーに Start\/Stop 以外のコマンドがある場合、それを適用するには次のフィールドに設定する必要があります。

![Shell リモートマネージャー 11](../../../images/shell_remotemanager_11.png)
