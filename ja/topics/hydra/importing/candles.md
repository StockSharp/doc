...
2. [S#](../../api.md) フィールドのインポート パラメーターを設定します。
   ...
   - **フィールド順序** - インポート対象項目のプロパティ列が配置される順序。
     ...
     次の設定がこれに対応します:![hydra import ローソク足プロパティ](../../../images/hydra_import_prop_candles.png)
...
3. データをプレビューするには、**プレビュー** ボタンをクリックします。![hydra import ローソク足プレビュー](../../../images/hydra_import_preview_candles.png)
4. **インポート** ボタンをクリックします。
