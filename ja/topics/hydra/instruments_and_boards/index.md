...
1. 最初の手順は **インデックス** の作成です。**すべての銘柄** タブで **銘柄を作成 \=\> インデックス** をクリックします。![hydra index sec 00](../../../images/hydra_index_sec_00.png)
...
5. 次に、**共通** タブで [ローソク足](../working_with_data/view_and_export/candles.md) をクリックし、作成した **インデックス** 銘柄とデータ期間を選択し、**作成元:** フィールドで **複合要素** を設定してから、![hydra find](../../../images/hydra_find.png) をクリックします。![hydra index candle](../../../images/hydra_index_candle.png)
