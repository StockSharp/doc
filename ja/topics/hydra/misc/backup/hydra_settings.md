...
1. タスクを作成するには、**Add tasks...** ボタンをクリックし、開いたウィンドウで **バックアップ** 項目を選択して **OK** ボタンをクリックします。![hydra tasks backup add](../../../../images/hydra_tasks_backup_add.png)
2. 次に、タスクを設定する必要があります。![hydra tasks backup](../../../../images/hydra_tasks_backup.png)
   ...
   **全般**
   - **ヘッダー** - Converter。
   - **稼働時間** - ボードの稼働スケジュールの設定。 ![hydra tasks backup desk](../../../../images/hydra_tasks_backup_desk.png)
   - **動作間隔** - 操作の間隔。
