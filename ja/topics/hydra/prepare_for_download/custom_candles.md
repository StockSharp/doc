...
3. ソースで、ローソク足を何から構築するかを指定します - **Ticks**。![hydra type candle 00 07](../../../images/hydra_type_candle_00_07.png)
4. 期間を設定します。
5. start をクリックすると、データのダウンロードが開始されます。![hydra type candle 00 08](../../../images/hydra_type_candle_00_08.png)
6. ローソク足セクションに移動して、[ダウンロードされたデータを確認](../working_with_data/view_and_export.md)します。![hydra type candle 00 09](../../../images/hydra_type_candle_00_09.png)
