...
![Hydra エクスポート 00](../../../images/hydra_export_00.png)
...
- 上記のパラメーターを選択した後、![Hydra 検索ボタン](../../../images/hydra_find.png) ボタンをクリックします。![hydra ローソク足 tf](../../../images/hydra_candles_tf.png)

コンテキストメニューを使用すると、マーケットデータ値テーブルの各種パラメーターを設定できます。行のグループ化、利用可能な列、表示形式などです。

![Hydra エクスポートコンテキスト](../../../images/hydra_export_context.png)
