# アダプターの初期化: Yuanta SPARK

次のコードは、[YuantaMessageAdapter](xref:StockSharp.Yuanta.YuantaMessageAdapter) を初期化して [Connector](xref:StockSharp.Algo.Connector) に追加する方法を示します。
