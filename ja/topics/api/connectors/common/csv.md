...
**CSV** - テキスト形式からのデータインポート。

現在の取引プラットフォーム向けの取引ロボットを書き始める前に、[Connectors](../../connectors.md) セクションのリンクを確認することを推奨します。

> [!CAUTION]
> このコネクターはマーケットデータフィードのみをサポートします。トランザクションはサポートされません。
...
[Rithmic アダプターの初期化](../stock_market/rithmic/adapter_initialization_rithmic.md)
