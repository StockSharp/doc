...
金融商品識別子は、**\[instrument code\]@\[board code\]** という構文を使用します。Apple Inc. 株式の場合、識別子は **AAPL@NASDAQ** です。デリバティブの場合、ボードコードは契約が取引されるボードです。たとえば、ES 指数の 6 月限先物契約は **ESM5@NYSE** として識別できます。
