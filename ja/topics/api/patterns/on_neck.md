...
入り首線 は、下降トレンドで形成される、2 本のローソク足から構成される弱気のトレンド継続ローソク足パターンです。このパターンは、強気派によるトレンド反転の一時的で失敗した試みを示し、その後に下降の動きが継続します。
...
![入り首線 パターン](../../../images/onneckpattern.png)

### 解釈

入り首線 は、下降トレンド継続のシグナルと見なされます。
...
入り首線 は、ショートポジションに入る、または強化する機会を提供します。
