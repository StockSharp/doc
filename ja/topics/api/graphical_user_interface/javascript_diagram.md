...
同じコンポーネントは、完全な **エディター** としても動作します。パレットから要素をドラッグし、ポートを接続し、ノードの編集や削除、元に戻す／やり直すを行えます。[インタラクティブエディタ](javascript_diagram/editor.md) と [イベントと API](javascript_diagram/events.md) を参照してください。
