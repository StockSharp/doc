...
| コントロール | クラス | 識別子 |
|---|---|---|
| [有効注文](javascript_trading_controls/active_orders.md) | `ActiveOrdersWidget` | `activeOrders` |
| [ポジション](javascript_trading_controls/positions.md) | `PositionsWidget` | `positions` |
| [約定履歴](javascript_trading_controls/trade_history.md) | `TradeHistoryWidget` | `tradeHistory` |
| [ウォッチリスト](javascript_trading_controls/watchlist.md) | `WatchlistWidget` | `watchlist` |
| [注文入力](javascript_trading_controls/order_entry.md) | `OrderEntryWidget` | `orderEntry` |
| [板情報](javascript_trading_controls/order_book.md) | `OrderBookWidget` | `orderbook` |
| [歩み値](javascript_trading_controls/trade_feed.md) | `TradeFeedWidget` | `tradefeed` |
