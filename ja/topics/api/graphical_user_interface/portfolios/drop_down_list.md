...
- [PortfolioComboBox.Portfolios](xref:StockSharp.Xaml.PortfolioComboBox.Portfolios) - ポートフォリオの一覧。
- [PortfolioComboBox.SelectedPortfolio](xref:StockSharp.Xaml.PortfolioComboBox.SelectedPortfolio) - 選択されたポートフォリオ。

以下は、その使用例のコードスニペットです。このコード例は *Samples\/InteractiveBrokers\/SampleIB* から取得しています。 
