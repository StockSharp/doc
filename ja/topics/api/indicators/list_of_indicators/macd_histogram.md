...
**Moving Averages Convergence-Divergence (MACD)** は、証券価格の 2 つの移動平均の関係をヒストグラムとして表示するモメンタム指標です。
...
MACD Histogram (MACD Histogram) を構築する際、ヒストグラムのバーは Signal ラインと MACD ラインの差を示し、指標の把握をさらに簡単にします。
