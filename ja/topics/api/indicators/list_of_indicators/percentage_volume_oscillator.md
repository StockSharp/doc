...
**Percentage Volume Oscillator (PVO)** は MACD に似たテクニカルインジケーターですが、価格ではなく取引量に適用され、取引量の高速および低速の指数移動平均の差をパーセンテージで表します。
...
Percentage Volume Oscillator の計算は、次の手順で行います。
...
Percentage Volume Oscillator は、次のように解釈できます。
