...
**Moomoo** integra a **Moomoo OpenAPI e OpenD** no StockSharp para obter dados de mercado e negociar.
...
Antes de desenvolver robôs de negociação para Moomoo, consulte as ligações na secção [Conectores](../../connectors.md).
