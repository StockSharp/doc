...
Use a visualização avançada para as propriedades restantes descritas na página de [Configuração do conector](configuration_primary.md). Mantenha os pontos de conexão preenchidos, salvo se o provedor tiver atribuído outros valores.
