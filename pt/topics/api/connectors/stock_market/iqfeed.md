...
Na janela **IQ Connect Login** aberta, introduza o **Login** e a **Password** (ou PIN) recebidos do serviço **iQFeed**. Estas credenciais não são as mesmas que o Login e a Password do site **iQFeed**. Depois de introduzir as credenciais, clique em **Connect**.
