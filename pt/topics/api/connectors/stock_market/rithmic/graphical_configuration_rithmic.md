...
- **nome de utilizador (transações)** - Nome de utilizador adicional. Utilizado quando o envio de transações é efetuado para um servidor separado.
- **Ponto (transações)** - Ponto de ligação ao sistema de execução de transações.
- **palavra-passe (transações)** - Palavra-passe adicional. Utilizada quando o envio de transações é efetuado para um servidor separado.
