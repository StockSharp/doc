...
**Tiger Brokers** integra a **Tiger Brokers OpenAPI** no StockSharp para obter dados de mercado e negociar.
...
Antes de desenvolver robôs de negociação para Tiger Brokers, consulte as ligações na secção [Conectores](../../connectors.md).
