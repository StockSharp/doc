...
**ITCH** - fornecedor de dados de mercado em tempo real para cotações de ações, Forex, notícias, contratos de futuros, etc..
...
[Inicialização do adaptador ITCH](itch/adapter_initialization_itch.md)
