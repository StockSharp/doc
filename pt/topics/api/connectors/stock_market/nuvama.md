...
O **conector Nuvama** conecta o StockSharp a uma corretora ou mercado eletrônico de instrumentos financeiros. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Nuvama, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](nuvama/configuration_nuvama.md)

[Configuração gráfica](nuvama/graphical_configuration_nuvama.md)

[Inicialização do adaptador](nuvama/adapter_initialization_nuvama.md)
