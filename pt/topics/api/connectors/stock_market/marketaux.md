...
O **conector Marketaux** conecta o StockSharp a um serviço profissional de dados e análises de mercado. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Marketaux, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](marketaux/configuration_marketaux.md)

[Configuração gráfica](marketaux/graphical_configuration_marketaux.md)

[Inicialização do adaptador](marketaux/adapter_initialization_marketaux.md)
