...
O **conector GuruFocus** conecta o StockSharp a um serviço profissional de dados e análises de mercado. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de GuruFocus, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](gurufocus/configuration_gurufocus.md)

[Configuração gráfica](gurufocus/graphical_configuration_gurufocus.md)

[Inicialização do adaptador](gurufocus/adapter_initialization_gurufocus.md)
