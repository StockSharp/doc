...
O **conector Toss Securities** conecta o StockSharp a uma corretora ou mercado eletrônico de instrumentos financeiros. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Toss Securities, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](toss_securities/configuration_toss_securities.md)

[Configuração gráfica](toss_securities/graphical_configuration_toss_securities.md)

[Inicialização do adaptador](toss_securities/adapter_initialization_toss_securities.md)
