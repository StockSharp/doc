# Configuração gráfica de CQG Web API
...
- **Palavra-passe de utilização única** - propriedade `OneTimePassword`.
- **Token de acesso** - propriedade `AccessToken`.
- **Identificador da organização** - propriedade `PrivateLabel`. Valor predefinido: `WebAPITest`.
- **Identificador do cliente** - propriedade `ClientId`. Valor predefinido: `WebAPITest`.
- **Versão do cliente** - propriedade `ClientVersion`. Valor predefinido: `StockSharp 5`.
