...
O **conector DNSE** conecta o StockSharp a uma corretora ou mercado eletrônico de instrumentos financeiros. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de DNSE, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](dnse/configuration_dnse.md)

[Configuração gráfica](dnse/graphical_configuration_dnse.md)

[Inicialização do adaptador](dnse/adapter_initialization_dnse.md)
