...
**IG Markets** integra a **APIs REST e de transmissão da IG** no StockSharp para obter dados de mercado e negociar.
...
Antes de desenvolver robôs de negociação para IG Markets, consulte as ligações na secção [Conectores](../../connectors.md).
