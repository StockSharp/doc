...
O **conector Bavest** conecta o StockSharp a um serviço profissional de dados e análises de mercado. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Bavest, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](bavest/configuration_bavest.md)

[Configuração gráfica](bavest/graphical_configuration_bavest.md)

[Inicialização do adaptador](bavest/adapter_initialization_bavest.md)
