...
**OpenECry (GAIN Futures)** - plataforma de negociação para negociar nas bolsas internacionais.
...
[Inicialização do adaptador OpenECry](openecry/adapter_initialization_openecry.md)

[Ligação de vários algoritmos](openecry/several_algorithms_connection.md)

[Operação simultânea do terminal e do algoritmo](openecry/simultaneous_terminal_and_algorithm_operation.md)
