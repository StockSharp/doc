...
- **Identificador** - ID único. Utilizado quando vários clientes estão ligados a um terminal ou gateway.
- **Tempo real** - Se devem ser utilizados dados em tempo real ou "congelados" no servidor da corretora.
