...
**Databento** liga o StockSharp à interface oficial **Databento Live and Historical APIs**.

O conector permite procurar instrumentos e receber dados de mercado históricos e em tempo real.
