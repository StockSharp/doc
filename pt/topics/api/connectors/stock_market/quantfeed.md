...
**QuantFEED** - fornecedor de dados de mercado em tempo real para cotações de ações, Forex, notícias, contratos de futuros, etc.

Antes de começar a escrever robôs de negociação para a plataforma de negociação atual, recomenda-se ler as ligações na secção [Conectores](../../connectors.md). 
...
[Inicialização do adaptador QuantFEED](quantfeed/adapter_initialization_quantfeed.md)
