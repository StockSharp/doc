...
O **conector BCS** conecta o StockSharp a uma corretora ou mercado eletrônico de instrumentos financeiros. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de BCS, do plano de API e da conta conectada.

## Veja também

[Configuração do conector](bcs/configuration_bcs.md)

[Configuração gráfica](bcs/graphical_configuration_bcs.md)

[Inicialização do adaptador](bcs/adapter_initialization_bcs.md)
