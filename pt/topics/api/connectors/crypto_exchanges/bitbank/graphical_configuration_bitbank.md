...
![Configurações da API GUI Bitbank](../../../../../images/api_gui_settings_bitbank.png)

- **chave** - Chave.
- **segredo** - Segredo.
- **Saldo** - Intervalo de verificação de saldo. Necessário em caso de ações de depósito e saque.
...
- **Solicitar contas de levantamento** - solicitar contas de levantamento.
