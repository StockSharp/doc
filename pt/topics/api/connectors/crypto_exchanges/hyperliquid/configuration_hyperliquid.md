...
Para trabalhar com o conector, especifique as credenciais de negociação ao nível da carteira.
...
- Modo de **rede de teste**.
 - **Endpoint de informação / endpoint de bolsa / endpoint WS**.
- **Deslizamento de mercado** para ordens de mercado.
...
- [Endpoint da bolsa](https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/exchange-endpoint)
