...
**CoinExchange** - fornecedor de dados de mercado em tempo real sobre criptomoedas.
...
> [!CAUTION]
> O conector suporta apenas a fonte de dados de mercado; transações não são suportadas.
