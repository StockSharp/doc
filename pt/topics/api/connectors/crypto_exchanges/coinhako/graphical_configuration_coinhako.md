# Configuração gráfica do Coinhako
...
- `CounterCurrencies` - moedas de cotação cujos mercados são solicitados.
- `PollingInterval` - intervalo entre consultas ao serviço.
