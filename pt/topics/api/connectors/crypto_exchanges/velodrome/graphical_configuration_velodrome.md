# Configuração gráfica: Velodrome
...
Use a visualização avançada para as propriedades restantes descritas na página de [Configuração do conector](configuration_velodrome.md). Mantenha os pontos de conexão preenchidos, salvo se o provedor tiver atribuído outros valores.
