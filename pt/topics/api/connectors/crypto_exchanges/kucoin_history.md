...
**Histórico Kucoin** - serviço público de dados históricos de mercado da Kucoin.

Antes de começar a escrever robôs de negociação para esta plataforma, recomendamos ler os links na secção [Conectores](../../connectors.md).

> [!CAUTION]
> O conector suporta apenas dados de mercado; as transações não são suportadas.
