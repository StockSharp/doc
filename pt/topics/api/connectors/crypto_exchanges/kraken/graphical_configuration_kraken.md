# Configuração gráfica de Kraken
...
![API GUI Settings Kraken](../../../../../images/api_gui_settings_kraken.png)

- **Key** - Key.
- **Secret** - Secret.
- **Balance** - intervalo de verificação do saldo. Necessário em caso de ações de depósito e levantamento.
- **Heart beat** - intervalo de verificação do servidor para acompanhar se a ligação está ativa. Por predefinição, igual a 1 minuto.
