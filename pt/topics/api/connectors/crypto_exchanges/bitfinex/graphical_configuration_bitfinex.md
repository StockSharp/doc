...
![Configurações da API GUI Bitfinex](../../../../../images/api_gui_settings_bitfinex.png)

- **Chave** - Chave.
- **Segredo** - Segredo.
- **Cancelar ao desconectar** - Cancela as ordens quando a ligação é interrompida.
