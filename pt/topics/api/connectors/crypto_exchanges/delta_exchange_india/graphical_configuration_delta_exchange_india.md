# Configuração gráfica: Delta Exchange India
...
Todas as propriedades específicas do adaptador estão listadas acima. Mantenha os endereços predefinidos, salvo se o provedor tiver atribuído valores diferentes.
