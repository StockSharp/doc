...
O código seguinte mostra como inicializar [FxcmMessageAdapter](xref:StockSharp.Fxcm.FxcmMessageAdapter) e adicioná-lo ao [Connector](xref:StockSharp.Algo.Connector).
