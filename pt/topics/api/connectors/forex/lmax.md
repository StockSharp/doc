...
**LMAX Global** - a LMAX Global é um broker de FX regulado pela FCA. A LMAX Global oferece a brokers e operadores profissionais a possibilidade de negociar no livro central de ordens limitadas da LMAX Exchange, disponibilizando spreads mais apertados sobre liquidez firme em fluxo contínuo de bancos de primeira linha e empresas de negociação proprietária.
