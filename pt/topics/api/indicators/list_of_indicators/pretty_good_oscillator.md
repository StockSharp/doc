...
O **Oscilador Bastante Bom (PGO)** é um indicador técnico desenvolvido por Mark Johnson que compara o preço de fecho atual com preços anteriores, considerando a volatilidade, para determinar condições de sobrecompra ou sobrevenda no mercado.
...
O Oscilador Bastante Bom (PGO) avalia a força do preço de fecho atual relativamente aos seus valores históricos durante um período específico. O PGO tem em conta não só a posição do preço atual no intervalo histórico, mas também a volatilidade desse intervalo, tornando-o mais adaptativo a condições de mercado em mudança.

O nome «Oscilador Bastante Bom» reflete a abordagem pragmática do seu criador: o indicador não pretende ser uma ferramenta perfeita, mas oferece uma forma bastante boa de avaliar a situação atual do mercado.
...
6. **Filtragem de sinais**:
   ...
   - Por exemplo, considerar apenas sinais altistas quando o PGO é positivo e apenas sinais baixistas quando o PGO é negativo
...
![Gráfico do indicador PGO](../../../../images/indicator_pretty_good_oscillator.png)
