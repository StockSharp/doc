...
**Intervalo verdadeiro médio (ATR)** é um indicador que mostra o nível de volatilidade atual.

Para usar o indicador, deve ser usada a classe [AverageTrueRange](xref:StockSharp.Algo.Indicators.AverageTrueRange).
##### Cálculo do indicador
  
O cálculo do indicador começa com a determinação do intervalo verdadeiro (TR), que é calculado como o máximo dos três valores seguintes:
