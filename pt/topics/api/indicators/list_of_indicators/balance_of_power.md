...
O indicador Equilíbrio de poder (BOP) apresenta o equilíbrio de forças entre compradores e vendedores no mercado. Baseia-se no pressuposto de que, numa tendência, os touros (compradores) ou os ursos (vendedores) conseguem controlar o preço ao longo da sessão. Ao comparar a diferença entre os preços de fecho e abertura com todo o intervalo de preços (máximo-mínimo), o indicador permite avaliar quem domina atualmente o mercado.
...
- **Valores positivos de BOP** (acima de zero) indicam que os touros (compradores) estão a controlar o mercado, o que pode sinalizar uma tendência ascendente.
- **Valores negativos de BOP** (abaixo de zero) indicam que os ursos (vendedores) estão a controlar o mercado, o que pode sinalizar uma tendência descendente.
