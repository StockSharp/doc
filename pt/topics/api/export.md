...
- **Tipo de dados** - o tipo de dados a exportar (ticks, velas, livro de ordens, etc.).
- **Codificação** - codificação (UTF-8 por predefinição).
...
- **Recuo** - formatação com indentação (predefinição `true`).
...
- **Tamanho do lote** - tamanho do lote para registos (predefinição 50).
...
- **Modelo de instrumentos** - modelo para instrumentos.
