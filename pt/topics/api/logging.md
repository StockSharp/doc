...
1. [FileLogListener](xref:Ecng.Logging.FileLogListener) - escreve mensagens num ficheiro de texto. Recomenda-se a sua utilização em algoritmos já criados e para usar os logs em casos de força maior.
...
[Logging de estratégia](logging/strategy_logging.md)

[Logging de IConnector](logging/iconnector_logging.md)

[Outras fontes de logs](logging/other_logs_sources.md)
