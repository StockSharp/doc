...
- A relação entre o corpo da vela e a sombra inferior demonstra a força dos compradores após testar níveis inferiores.
- Numa tendência descendente, pode sinalizar uma potencial reversão.
- Numa tendência ascendente, confirma a força da tendência, especialmente após uma correção.
...
- Utilizar para confirmar sinais de tendência ascendente de indicadores como MACD ou Moving Averages.
