...
### Três exteriores altistas

Este padrão de velas altista tem as seguintes características:

1. O mercado está numa tendência descendente.
2. A primeira vela é baixista.
...
Esta variação do padrão é um modelo de velas baixista com as seguintes características:

1. O mercado está numa tendência ascendente.
2. A primeira vela é altista.
3. A segunda vela é baixista, com um corpo longo que engloba totalmente a primeira vela.
4. A terceira vela é baixista, com um fecho mais baixo do que a segunda vela.
...
[Padrão Três interiores baixistas e Três interiores altistas](3_inside_down_3_side_up.md)
