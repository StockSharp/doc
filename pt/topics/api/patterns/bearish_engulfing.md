...
- A primeira vela é branca, com preço de abertura inferior ao preço de fecho (O < C).
- A segunda vela é preta, com preço de abertura superior ao preço de fecho (O > C).
- O preço de abertura da segunda vela é superior ao preço de fecho da primeira vela (O > pC).
- O preço de fecho da segunda vela é inferior ao preço de abertura da primeira vela (C < pO).
...
- O lucro alvo pode ser definido com base em níveis de suporte anteriores, na relação risco/recompensa ou utilizando indicadores técnicos.
- Volume de negociação elevado durante a formação da segunda vela aumenta significativamente a fiabilidade do sinal.
- Combinar com outros indicadores, como RSI na zona de sobrecompra ou divergência em osciladores, para aumentar a probabilidade de uma negociação bem-sucedida.
- Também pode ser utilizado como sinal para fechar posições longas existentes.
