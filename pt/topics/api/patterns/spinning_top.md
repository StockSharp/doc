...
- Corpo pequeno da vela (pode ser branco/verde ou preto/vermelho).
- Sombras superior e inferior longas, de comprimento aproximadamente igual.
...
- Dentro de uma tendência ascendente, pode sinalizar enfraquecimento do momentum altista.
- Dentro de uma tendência descendente, pode indicar exaustão da pressão baixista.
- No topo de uma tendência ou antes de um nível de resistência importante, pode antecipar uma reversão.
