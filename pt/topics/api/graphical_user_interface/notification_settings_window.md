...
![Captura de ecrã de Janela de definições de notificações](../../../images/api_gui_alertwindow.png)
...
- **Registo** - será enviada uma mensagem para a janela Registos do Designer.
