...
[PortfolioComboBox](xref:StockSharp.Xaml.PortfolioComboBox) é uma caixa de combinação para selecionar portfólios.

![Captura de tela de Lista pendente](../../../../images/gui_portfoliocombobox.png)

**Propriedades principais**

- [PortfolioComboBox.Portfolios](xref:StockSharp.Xaml.PortfolioComboBox.Portfolios) - a lista de portfólios.
- [PortfolioComboBox.SelectedPortfolio](xref:StockSharp.Xaml.PortfolioComboBox.SelectedPortfolio) - o portfólio selecionado.
