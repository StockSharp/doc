...
[EquityCurveChart](xref:StockSharp.Xaml.Charting.EquityCurveChart) - o componente gráfico para apresentar a curva de capital.
...
![Captura de ecrã de Gráfico de curva de capital](../../../../images/gui_equitycurvechart.png)

## Exemplo de desenho do EquityCurveChart

1. Adicionamos o componente gráfico [EquityCurveChart](xref:StockSharp.Xaml.Charting.EquityCurveChart) ao XAML. Atribuímos o nome **Curve** ao componente.
...
2. No código da janela principal, criamos uma origem de dados para desenhar o gráfico utilizando o método [EquityCurveChart.CreateCurve](xref:StockSharp.Xaml.Charting.EquityCurveChart.CreateCurve(System.String,System.Windows.Media.Color,System.Windows.Media.Color,Ecng.Drawing.DrawStyles,System.Guid))**(**[System.String](xref:System.String) title, [System.Windows.Media.Color](xref:System.Windows.Media.Color) color, [System.Windows.Media.Color](xref:System.Windows.Media.Color) secondColor, [Ecng.Drawing.DrawStyles](xref:Ecng.Drawing.DrawStyles) style, [System.Guid](xref:System.Guid) id **)**.
   ...
   ```
3. Quando o valor PnL da estratégia é alterado, adicionamos dados à origem de dados. Neste caso, utilizamos a classe especial [ChartDrawData](xref:StockSharp.Xaml.Charting.ChartDrawData).
