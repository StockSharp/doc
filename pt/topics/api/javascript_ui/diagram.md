...
Em seguida, importe os módulos ES — `import { renderScheme } from '@stocksharp/diagram/embed'` para o embed só de leitura, ou `import { StockSharpDiagram } from '@stocksharp/diagram'` para o [editor interativo](diagram/editor.md).
...
O mesmo componente também funciona como um **editor** completo — arraste elementos de uma paleta, ligue portas, edite e elimine nós, anule ou refaça operações. Consulte [Editor interativo](diagram/editor.md) e [Eventos e API](diagram/events.md).

## Veja também

- [Editor interativo](diagram/editor.md)
- [Eventos e API](diagram/events.md)
