...
|---|---|---|
| [Ordens ativas](trading_controls/active_orders.md) | `ActiveOrdersWidget` | `activeOrders` |
| [Posições](trading_controls/positions.md) | `PositionsWidget` | `positions` |
| [Histórico de negócios](trading_controls/trade_history.md) | `TradeHistoryWidget` | `tradeHistory` |
| [Lista de instrumentos](trading_controls/watchlist.md) | `WatchlistWidget` | `watchlist` |
