...
2. Para cada instrumento selecionado, deve selecionar os tipos de dados de mercado necessários para transferência.
   ...
   Se nem todos os parâmetros necessários do instrumento estiverem definidos, o ícone ![hydra zero](../../images/hydra_zero.png) aparecerá na coluna esquerda da linha do instrumento. ![hydra escolher tipo de dados de mercado](../../images/hydra_type_market_data_choose.png)
