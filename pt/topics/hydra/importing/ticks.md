...
![Hydra importação de negociações](../../../images/hydra_import_trades.png)
...
2. Configure os parâmetros de importação para os campos [S#](../../api.md).
   ...
   **Vejamos um exemplo de importação de transações (ticks) a partir de um ficheiro CSV:**
   ...
   - A janela de definição dos campos terá este aspeto:![Hydra propriedades de importação de negociações](../../../images/hydra_import_prop_trade.png)
...
3. Para pré-visualizar os dados, clique no botão **Pré-visualizar**.![Hydra pré-visualização da importação de negociações](../../../images/hydra_import_preview_trade.png)
