...
![Captura de ecrã de Instrumentos 1](../../../images/hydra_import_securities.png)
...
2. Configure os parâmetros de importação para os campos [S#](../../api.md).
   ...
   **Vamos considerar um exemplo de importação de um instrumento a partir de um ficheiro CSV:**
   ...
   - A janela de definição de campos terá o seguinte aspeto:![Captura de ecrã de Instrumentos 2](../../../images/hydra_import_prop_securitiy.png)
...
3. Para pré-visualizar os dados, clique no botão **Pré-visualizar**.![Captura de ecrã de Instrumentos 3](../../../images/hydra_import_preview_securitiy.png)
