...
![Hydra importação de velas](../../../images/hydra_import_candles.png)
...
2. Configure os parâmetros de importação para os campos [S#](../../api.md).
   ...
   - **Ordem dos campos** - sequência em que estão dispostas as colunas de propriedades do item importado.
     ...
     Então a seguinte definição corresponderá a esse modelo:![Hydra propriedades de importação de velas](../../../images/hydra_import_prop_candles.png)
...
3. Para pré-visualizar os dados, clique no botão **Pré-visualizar**.![Hydra pré-visualização da importação de velas](../../../images/hydra_import_preview_candles.png)
