...
- Como várias origens não oferecem a possibilidade de descarregar alguns dados, o programa disponibiliza o campo [Build from](any_market_data_types.md). Usando este campo, o utilizador pode construir dados de mercado a partir de outro tipo de dados de mercado. A mesma função pode ser usada para construir dados de mercado sem descarregamento adicional, usando como base dados já existentes.
