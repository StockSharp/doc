...
Ao clicar no botão **Iniciar** ![hydra analytics compile](../../../images/hydra_analytics_compile.png), será aberto um novo separador com os resultados da execução do script.
