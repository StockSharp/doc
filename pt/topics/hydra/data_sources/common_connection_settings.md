...
![Hydra configurações de parâmetros de ligação](../../../images/hydra_settings_connectionparams.png)

**Ligação**

- **Ligação** - Definições de ligação.
- **Título** - Nome da tarefa.
- **Data inicial (ticks)** - Data a partir da qual iniciar a transferência dos dados.
- **Trabalhar desde** - Hora de início.
- **Trabalhar até** - Hora de fim.
...
- **Dependência** - Tarefa que deve ser concluída antes de iniciar a atual.
