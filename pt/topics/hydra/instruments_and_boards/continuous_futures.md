...
2. Para criar um futuro contínuo, é necessário especificar um nome e adicionar contratos.
   ...
   - Manualmente, clicando no botão ![Hydra botão Adicionar](../../../images/hydra_add.png).![HydraGluingCSCustom](../../../images/hydragluingcscustom.png)
...
5. Em seguida, clique no botão [Velas](../working_with_data/view_and_export/candles.md) no separador **Comum**, selecione o instrumento resultante e o período dos dados, defina o valor **Elemento composto** no campo **Criar a partir de** e depois clique no botão ![Hydra botão Procurar](../../../images/hydra_find.png). ![HydraGluingTrades](../../../images/hydragluingtrades.png)
