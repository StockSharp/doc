...
1. Para criar uma tarefa, clique no botão **Add tasks...**; na janela que se abre, selecione o item **Cópia de segurança** e clique no botão **OK**.![hydra tasks backup add](../../../../images/hydra_tasks_backup_add.png)
...
- **Login** - login. ID da chave de acesso.
   ...
   **Registo**
   ...
   - **Nível de registo** - o nível de logging.
