...
1. Para criar uma tarefa, clique no botão **Adicionar tarefas...**; na janela que se abre, selecione o item **Cópia de segurança** e clique no botão **OK**.![Captura de ecrã de Definições do Hydra 1](../../../../images/hydra_tasks_backup_add.png)
2. Em seguida, é necessário configurar a tarefa.![Captura de ecrã de Definições do Hydra 2](../../../../images/hydra_tasks_backup.png)
