...
![Designer Painel de circuitos 00](../../../images/designer_panel_circuits_00.png)

1. A pasta **Teste histórico** contém estratégias de negociação criadas tanto como esquemas a partir de um conjunto de elementos e ligações entre eles, como a partir de código. Pode adicionar uma nova estratégia premindo o botão **Adicionar** ![Designer Painel de circuitos 01](../../../images/designer_panel_circuits_01_button.png) no separador **Geral** e selecionando **Estratégia**. Ou clicando com o botão direito do rato na pasta **Teste histórico** no painel **Esquemas** e premindo o botão **Adicionar** ![Designer Painel de circuitos 01](../../../images/designer_panel_circuits_01_button.png) no menu pendente. Na janela que se abre, selecione exatamente como pretende criar uma estratégia.

    ![Designer Painel de circuitos 04](../../../images/designer_panel_circuits_04.png)
