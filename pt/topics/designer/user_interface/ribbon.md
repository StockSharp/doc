...
O principal elemento da interface de utilizador do [Designer](../../designer.md) é o **Faixa de opções**, que percorre a parte superior da janela da aplicação. O Ribbon permite aceder rapidamente aos comandos necessários. Os comandos estão organizados em grupos lógicos, reunidos em separadores. Para navegar para o separador pretendido, basta clicar no respetivo título (nome). Cada separador está associado ao tipo de ação que está a ser executada.

1. O separador **Geral**, que abre por predefinição após o arranque, contém elementos que podem ser necessários na fase inicial de trabalho. A partir do separador **Geral**, pode abrir [Connection Settings](../connections_settings.md), [Scheme Panel](schemas.md), [Painel Logs](logs.md), [Carteiras](portfolios.md), [Board Editor](boards.md), [Creating a Repository of Historical Data](../market_data_storage/getting_started.md). Também no separador **Geral**, pode adicionar, abrir, eliminar, importar e exportar estratégias. Se quiser partilhar a sua estratégia com a comunidade, pode fazê-lo clicando no botão *Publish*. O botão adjacente, *Available Strategies*, abre algoritmos publicados por si e por outros utilizadores. À direita, existem botões de serviço para chamar a ajuda, bem como para contactar-nos. Pode comunicar um problema ou escrever-nos no chat do Telegram.
