...
Nos painéis [Definições de testes históricos](components/backtesting_settings.md) e [Definições de negociação em tempo real](components/live_settings.md), pode definir as definições de controlo de risco.
