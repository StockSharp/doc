...
Quando seleciona qualquer bloco no painel **Designer**, o painel **Properties** mostra as propriedades desse bloco. No painel **Properties** do bloco **Candles**, pode configurar o tipo de candle e o Time Frame ([Velas](../api/candles.md)).
