...
Por exemplo, o cubo [Order book](elements/market_depths/order_book.md) gera um evento de alteração do livro de ordens. Não se sabe antecipadamente quando ocorrerá uma alteração. Ao criar uma linha de ligação entre o cubo [Order book](elements/market_depths/order_book.md) e o cubo [Converter](elements/converters/converter.md), é efectuada uma subscrição da alteração do livro de ordens para posterior processamento com o cubo [Converter](elements/converters/converter.md), etc.:
