...
![Captura de ecrã de Variável](../../../../../../images/designer_variable_00.png)
...
- **Acionador** – o sinal (qualquer valor exceto `False`) que determina o momento em que é necessário passar o valor armazenado através do conector de saída.
...
Se o tipo de dados **Instrumento** ou **Carteira** estiver selecionado, o valor predefinido pode estar em falta. Neste caso, se a opção **Parâmetros** estiver definida nas propriedades, quando a estratégia for executada, estes dados serão retirados das propriedades correspondentes da estratégia.
