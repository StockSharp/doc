...
- **Ignorar erros** - a flag definida indica que os erros serão ignorados ao calcular o índice.
- **Calcular informação alargada** - a flag definida indica que, ao calcular o índice, além da informação básica (Volume total, Preço de abertura, Preço de fecho, Preço máximo, Preço mínimo), será calculada a informação alargada (Volume financeiro total das transações, Volume de abertura, Volume de fecho, Volume máximo, Volume mínimo).
