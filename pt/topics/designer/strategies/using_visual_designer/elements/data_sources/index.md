...
- **Security** - o índice calculado, representado como uma **Security**.

### Parâmetros

Parâmetros

- **Index** - a fórmula matemática de uma combinação de vários instrumentos (por exemplo, (AAPL@NASDAQ+10)\*(abs(20\/GOOG@NYSE)).
