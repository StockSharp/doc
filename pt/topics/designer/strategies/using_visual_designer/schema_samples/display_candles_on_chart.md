...
Para o cubo [Chart](../elements/common/chart.md), foi adicionado um elemento gráfico com tipo de vela, para o qual o parâmetro de entrada foi adicionado automaticamente.

Depois de adicionar os elementos gráficos necessários ao painel do gráfico, é adicionada a ligação dos elementos [Candles](../elements/data_sources/candles.md) e [Chart](../elements/common/chart.md), através da qual as velas construídas serão passadas para apresentação no gráfico.
