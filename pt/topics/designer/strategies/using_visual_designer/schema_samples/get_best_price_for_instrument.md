...
Para o cubo [Variável](../elements/data_sources/variable.md), é seleccionado o tipo de dados **Instrument**. Se o instrumento não for especificado, mas a flag **Parameters** do grupo de propriedades **Common** estiver definida, então será retirado da estratégia e passado para o cubo [Livro de ofertas](../elements/market_depths/order_book.md). O cubo [Livro de ofertas](../elements/market_depths/order_book.md), depois de receber o instrumento actual a partir da variável, passa as alterações do livro de ordens do instrumento seleccionado através do parâmetro de saída. Ao receber alterações do livro de ordens, o cubo [Conversor](../elements/converters/converter.md) escolhe delas o valor actual do melhor preço de compra.
