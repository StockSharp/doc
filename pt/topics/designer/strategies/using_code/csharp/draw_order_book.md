...
Uma estratégia criada a partir de código pode desenhar dados no painel [Order Book](../../../user_interface/components/order_book.md), de forma semelhante ao cubo [Order Book](../../using_visual_designer/elements/market_depths/order_book_panel.md). Para isso, é necessário escrever o seguinte código.
...
4. Adicione o painel [Order Book](../../../user_interface/components/order_book.md) e selecione a fonte criada no código:
