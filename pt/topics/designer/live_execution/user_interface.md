...
Depois de adicionar uma estratégia à pasta **Ao vivo**, ao fazer duplo clique na estratégia adicionada, abre-se um separador intitulado "Ao vivo [Nome da estratégia]". Ao navegar para este separador, o separador **Ao vivo** abre-se automaticamente no **Friso**. No separador **Ao vivo**, pode especificar o instrumento e o portefólio com os quais a estratégia irá trabalhar. Ao premir o botão **Iniciar**, inicia a negociação ao vivo para a estratégia; ao premir o botão **Parar**, interrompe-a.
