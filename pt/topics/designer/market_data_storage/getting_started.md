...
Para criar um armazenamento de dados históricos, clique no botão ![Designer Criação de um repositório de dados históricos 00](../../../images/designer_creating_repository_of_historical_data_00.png) no separador **Dados de mercado**. Clique em ![Designer Criação de um repositório de dados históricos 01](../../../images/designer_creating_repository_of_historical_data_01.png) para alterar os parâmetros do armazenamento atual. Clique em ![Designer Criação de um repositório de dados históricos 02](../../../images/designer_creating_repository_of_historical_data_02.png) para eliminar o armazenamento atual da lista de armazenamentos.

![Designer Criação de um repositório de dados históricos 03](../../../images/designer_creating_repository_of_historical_data_03.png)
...
Depois disso, no [Designer](../../designer.md), crie um novo armazenamento clicando no botão ![Designer Criação de um repositório de dados históricos 00](../../../images/designer_creating_repository_of_historical_data_00.png). Nas definições de armazenamento, no campo de endereço, especifique "net.tcp:\/\/localhost:8000". Clique em OK. Ao usar o [Hydra](../../hydra.md) como armazenamento remoto, não se esqueça de que o [Hydra](../../hydra.md) deve estar iniciado e configurado em conformidade.

![Designer Criação de um repositório de dados históricos 05](../../../images/designer_creating_repository_of_historical_data_05.png)

Depois de adicionar um novo armazenamento, este pode ser selecionado na lista pendente **Armazenamento**.

![Designer Criação de um repositório de dados históricos 06](../../../images/designer_creating_repository_of_historical_data_06.png)
