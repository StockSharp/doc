...
- **Estratégias** armazena, como ficheiros XML, todos os blocos da pasta **Estratégias** no [Painel de esquemas](../user_interface/schemas.md). Eliminar ficheiros desta pasta remove a estratégia da pasta **Estratégias** no Painel de esquemas. Não edite estes ficheiros manualmente; fazê-lo pode danificar a estratégia correspondente. Se adicionar manualmente um ficheiro de estratégia a esta pasta e reiniciar o [Designer](../../designer.md), a estratégia aparece na pasta **Estratégias** no [Painel de esquemas](../user_interface/schemas.md).
