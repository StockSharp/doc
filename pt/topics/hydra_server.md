...
> [!TIP]
> No Windows, o Hydra Server pode ser registado como um Windows Service e iniciado automaticamente no arranque do sistema. Para mais informações, consulte [Windows service](https://en.wikipedia.org/wiki/Windows_service).
...
- **CompanyPath** - se usar o programa como Windows Service, é necessário definir o caminho como "C:\\Users\\%user_name%\\Documents\\StockSharp".
