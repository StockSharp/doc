...
O motor independente de gráficos para navegador e o conjunto de gráficos para terminais web são mantidos em [StockSharp\/Charts](https://github.com/StockSharp/Charts). Consulte [Gráficos JavaScript](../api/graphical_user_interface/charts/javascript_charts.md).
