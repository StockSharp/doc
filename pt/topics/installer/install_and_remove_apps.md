...
![escolher instalador](../../images/choose_installer.png)

Para instalar a aplicação necessária, é preciso:

1. Selecionar uma aplicação, clicar em **Instalar**, aceitar o contrato de licença e clicar em **Continuar**.![transferir instalador](../../images/download_installer.png)
2. Depois disso, é necessário selecionar o caminho de instalação. 

   **IMPORTANTE\!** A pasta na qual o programa será instalado deve estar vazia.

   Clique em **Continuar**.![direção do instalador](../../images/direction_installer.png)
...
![excluir instalador](../../images/del_installer.png)

Para restaurar, selecione **Restaurar** e clique em **Continuar**.

![reparar instalador](../../images/repair_installer.png)
