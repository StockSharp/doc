...
По умолчанию в [PlazaMessageAdapter](xref:StockSharp.Plaza.PlazaMessageAdapter) используются стаканы глубиной в 5 котировок. Чтобы изменить глубину стакана, необходимо в свойство [DefaultDepthTable](xref:StockSharp.Plaza.PlazaMessageAdapter.DefaultDepthTable) присвоить соответствующее значение: 
