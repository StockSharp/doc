...
|---|---|---|
| [Активные заявки](javascript_trading_controls/active_orders.md) | `ActiveOrdersWidget` | `activeOrders` |
| [Позиции](javascript_trading_controls/positions.md) | `PositionsWidget` | `positions` |
| [История сделок](javascript_trading_controls/trade_history.md) | `TradeHistoryWidget` | `tradeHistory` |
| [Список инструментов](javascript_trading_controls/watchlist.md) | `WatchlistWidget` | `watchlist` |
| [Ввод заявки](javascript_trading_controls/order_entry.md) | `OrderEntryWidget` | `orderEntry` |
| [Стакан](javascript_trading_controls/order_book.md) | `OrderBookWidget` | `orderbook` |
| [Лента сделок](javascript_trading_controls/trade_feed.md) | `TradeFeedWidget` | `tradefeed` |
