...
![Снимок экрана: Таблица редактирования свойств объектов](../../../images/gui_propertydatagridex.png)
...
public MainWindow()
{
	...
	{
		_connector.Load(new JsonSerializer<SettingsStorage>().Deserialize(_settingsFile));
	}
