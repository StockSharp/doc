...
**Конечная скользящая средняя (EPMA)** - это технический индикатор, который представляет собой модификацию стандартной скользящей средней, разработанную для уменьшения задержки при определении трендов.
...
1. Определение линейного тренда между начальной и конечной точками периода:
   ```
   начальное значение = Price[текущий - Length + 1]
   конечное значение = Price[текущий]
   ```

2. Расчет угла наклона (slope) линии тренда:
   ```
   Slope = (конечное значение - начальное значение) / (Length - 1)
   ```

3. Вычисление EPMA как проекции линии тренда на текущую точку:
   ```
   EPMA = начальное значение + Slope * (Length - 1)
   ```

Фактически, EPMA равен последнему значению цены (конечное значение) в рассматриваемом периоде, но концептуально это проекция линейного тренда, определенного конечными точками.
...
![График индикатора EPMA](../../../../images/indicator_endpoint_moving_average.png)
