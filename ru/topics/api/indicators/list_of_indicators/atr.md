...
**Средний истинный диапазон (ATR)** — индикатор показывающий уровень текущей волатильности.
...
Расчет индикатора начинается с определения истинного диапазона (TR), который вычисляется как максимум из следующих трех величин:
...
![График индикатора ATR](../../../../images/indicatoraveragetruerange.png)
