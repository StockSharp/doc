...
**Стохастический осциллятор %K** - это компонент стохастического осциллятора, который показывает текущую позицию цены закрытия относительно диапазона цен за выбранный период. Индикатор разработан Джорджем Лейном в конце 1950-х годов.
