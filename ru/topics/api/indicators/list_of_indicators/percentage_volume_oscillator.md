...
**Осциллятор процентного объема (PVO)** - это технический индикатор, аналогичный MACD, но применяемый к объему торгов вместо цены, и выражающий разницу между быстрой и медленной экспоненциальными скользящими средними объема в процентном отношении.
...
![График индикатора PVO](../../../../images/indicator_percentage_volume_oscillator.png)
