...
**Индекс размаха (индекс изменчивости, CHOP)** - это индикатор, разработанный для определения, находится ли рынок в боковом движении (внутри диапазона) или в трендовом состоянии.
...
1. Расчет суммы истинных диапазонов за выбранный период:
   ```
...
![График индикатора CHOP](../../../../images/indicator_choppiness_index.png)
