...
**Индекс отрицательного объема (индекс отрицательного объема, NVI)** - это технический индикатор, разработанный Полом Дизом, который фокусируется на изменениях цены в дни, когда объем торгов снижается по сравнению с предыдущим днем.
...
NVI часто используется вместе с дополнительным индикатором - индекс положительного объема (PVI), который, напротив, учитывает только те дни, когда объем растет.
...
![График индикатора NVI](../../../../images/indicator_negative_volume_index.png)
