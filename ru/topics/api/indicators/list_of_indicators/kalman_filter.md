...
**Фильтр Калмана (фильтр Калмана)** — рекурсивный алгоритм, позволяющий оценивать скрытое состояние системы по зашумленным наблюдениям.
...
![График индикатора KalmanFilter](../../../../images/indicator_kalman_filter.png)
