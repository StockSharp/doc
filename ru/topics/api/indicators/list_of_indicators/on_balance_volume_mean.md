...
**Среднее значение объема баланса (балансовый объем Mean, OBVM)** - это технический индикатор, который представляет собой скользящее среднее от индикатора балансовый объем (OBV), позволяющее выявить более четкие сигналы тренда на основе объема.
...
1. Расчет базового индикатора балансовый объем (OBV):
   ```
...
![График индикатора OBVM](../../../../images/indicator_on_balance_volume_mean.png)
