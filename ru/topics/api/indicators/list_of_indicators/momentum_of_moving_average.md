...
**Импульс скользящей средней (MOMA)** - это технический индикатор, который измеряет скорость изменения скользящей средней цены, объединяя концепции импульса и скользящих средних.
...
![График индикатора MOMA](../../../../images/indicator_momentum_of_moving_average.png)
