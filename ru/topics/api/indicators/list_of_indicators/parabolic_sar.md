...
**Параболический SAR** \- Трендовый индикатор, который указывает точки остановки и разворота цены, а также направление тренда.
...
![График индикатора параболический SAR](../../../../images/indicatorparabolicsar.png)
