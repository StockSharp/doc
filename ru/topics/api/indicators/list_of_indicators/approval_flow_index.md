...
**Индекс потока утверждения (индекс потока подтверждения, AFI)** - это индикатор, который измеряет силу тренда, основываясь на соотношении объема и движении цены.
...
![График индикатора AFI](../../../../images/indicator_approval_flow_index.png)
