...
**Пересечение скользящих средних (MAC)** - это технический индикатор, который отслеживает пересечения между короткой и длинной скользящими средними для определения потенциальных точек входа и выхода с рынка.
...
MAC широко используется как в самостоятельных торговых стратегиях, так и в составе более сложных систем, таких как MACD (схождение/расхождение скользящих средних).
...
5. **Комбинирование с другими индикаторами**:
   - MAC часто используется в сочетании с индикаторами импульса (RSI, Стохастик) для подтверждения сигналов
...
![График индикатора MAC](../../../../images/indicator_moving_average_crossover.png)
