...
**балансовый объем (OBV)** - это технический индикатор, разработанный Джозефом Гранвиллем, который использует объем торгов для прогнозирования изменений цены путем накопления объема в зависимости от направления изменения цены.
...
Индикатор OBV был впервые представлен Джозефом Гранвиллем в 1963 году в его книге "Новый ключ Гранвилла к прибыли на фондовом рынке" и с тех пор стал одним из наиболее широко используемых индикаторов объема.

## Расчет

Расчет балансовый объем очень прост:
...
балансовый объем можно интерпретировать следующим образом:
...
![График индикатора OBV](../../../../images/indicator_on_balance_volume.png)
