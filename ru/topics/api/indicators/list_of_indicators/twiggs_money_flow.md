...
**Денежный поток Твиггса (TMF)** - это индикатор объема, разработанный Колином Твиггсом как усовершенствованная версия индикатора денежного потока Чайкина. TMF более чувствителен к изменениям рыночного настроения и имеет меньшее количество ложных сигналов.
...
Денежный поток Твиггса анализирует взаимосвязь между ценой и объемом для определения направления денежного потока в рынок или из него. В отличие от традиционных индикаторов объема, TMF устраняет шум, нормализуя значения между -1 и +1.
...
Расчет денежного потока Твиггса выполняется в несколько этапов:
...
2. Определяется объем денежного потока Твиггса (TMFV):
   ```
