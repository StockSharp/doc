...
**Сигнал осциллятора процентной цены (PPOS)** — модификация стандартного осциллятора процентной цены (PPO), в которой особое внимание уделяется сигнальной линии для фильтрации торговых сигналов.
...
- [Осциллятор процентной цены](percentage_price_oscillator.md)
