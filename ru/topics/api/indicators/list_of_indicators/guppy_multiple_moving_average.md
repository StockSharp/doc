...
**Множественная скользящая средняя Guppy (GMMA)** - это технический индикатор, разработанный Дарилом Гуппи, который использует две группы экспоненциальных скользящих средних (EMA) для выявления взаимодействия между краткосрочными трейдерами и долгосрочными инвесторами.
...
![График индикатора GMMA](../../../../images/indicator_guppy_multiple_moving_average.png)
