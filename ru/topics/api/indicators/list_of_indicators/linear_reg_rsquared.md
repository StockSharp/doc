...
**R-квадрат в линейной регрессии (R-квадрат линейной регрессии)** - это технический индикатор, который измеряет, насколько хорошо линейная регрессия аппроксимирует ценовые данные, и определяет силу тренда на рынке.
...
2. Расчет суммы квадратов отклонений от регрессии (SSE):
   ```
   SSE = Сумма((фактическая цена - прогнозная цена)^2)
   ```
   где:
   - фактическая цена - фактическая цена
   - прогнозная цена - прогнозируемая цена из уравнения регрессии

3. Расчет общей суммы квадратов (SST):
   ```
   SST = Сумма((фактическая цена - средняя цена)^2)
   ```
   где средняя цена - среднее значение цены за период Length
...
![График индикатора R-квадрат](../../../../images/indicator_linear_reg_rsquared.png)
