...
**Синтетическая цена без тренда (синтетическая цена без тренда, DSP)** - это технический индикатор, который удаляет общий тренд из ценового ряда, позволяя трейдерам сосредоточиться на краткосрочных колебаниях цены.
...
Расчет индикатора синтетическая цена без тренда включает следующие этапы:
...
![График индикатора DSP](../../../../images/indicator_detrended_synthetic_price.png)
