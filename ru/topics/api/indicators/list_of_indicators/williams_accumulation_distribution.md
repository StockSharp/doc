...
Расчет индикатора накопление/распределение Уильямса осуществляется по следующей логике:
