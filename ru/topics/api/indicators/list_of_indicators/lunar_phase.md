...
**Индикатор лунной фазы (Лунная фаза, LP)** - это нестандартный технический индикатор, который основывается на астрономических данных о фазах Луны для анализа потенциального влияния лунных циклов на финансовые рынки.
...
![График индикатора LP](../../../../images/indicator_lunar_phase.png)
