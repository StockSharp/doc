...
**Индекс фрактальной размерности (индекс фрактальной размерности, FDI)** – показатель хаотичности ценового движения.
...
![График индикатора FDI](../../../../images/indicator_fractal_dimension.png)
