...
**Индикатор импульса пинбола (моментум-пинбол, MP)** - это технический индикатор, который анализирует импульс цены и его изменения для определения потенциальных точек разворота и силы тренда на рынке.
...
![График индикатора MP](../../../../images/indicator_momentum_pinball.png)
