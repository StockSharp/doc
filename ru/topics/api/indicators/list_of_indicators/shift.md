...
**Сдвиг** — вспомогательный индикатор, который сдвигает исходный поток значений на заданное количество периодов. Он не изменяет
...
![График индикатора Сдвиг](../../../../images/indicator_shift.png)
