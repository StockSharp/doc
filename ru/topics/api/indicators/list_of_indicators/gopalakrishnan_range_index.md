...
**Индекс диапазона Гопалакришнана (индекс диапазона Гопалакришнана, GAPO)** - это технический индикатор, разработанный Тушаром Гопалакришнаном для измерения волатильности рынка на основе логарифмической шкалы.
...
```
GAPO = log(N) * log(наивысший максимум - наинизший минимум)
```

где:
- log - натуральный логарифм
- N - количество периодов (Length)
- наивысший максимум - наивысший максимум за период Length
- наинизший минимум - наинизший минимум за период Length
...
![График индикатора GAPO](../../../../images/indicator_gopalakrishnan_range_index.png)
