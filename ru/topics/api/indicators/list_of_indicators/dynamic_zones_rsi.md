...
**Индекс относительной силы в динамических зонах (RSI динамических зон, DZRSI)** - это модификация классического индекса относительной силы (RSI), которая использует динамически изменяющиеся уровни перекупленности и перепроданности вместо статических.
...
3. Адаптация уровней перекупленности и перепроданности на основе этого диапазона:
   ```
   Динамический уровень перекупленности = Базовый уровень перекупленности + Корректировка на основе исторических данных
   Динамический уровень перепроданности = Базовый уровень перепроданности - Корректировка на основе исторических данных
   ```
...
![График индикатора DZRSI](../../../../images/indicator_dynamic_zones_rsi.png)
