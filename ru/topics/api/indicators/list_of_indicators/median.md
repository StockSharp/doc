...
**Скользящая медиана** — индикатор сглаживания, который вычисляет медиану последних N значений. В отличие от скользящих средних, медиана
...
- Скользящая медиана может использоваться как альтернатива скользящим средним при работе с шумными данными.
...
![График индикатора Скользящая медиана](../../../../images/indicator_median.png)
