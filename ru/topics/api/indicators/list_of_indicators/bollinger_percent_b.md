...
**Bollinger %b (процент Боллинджера B, BBP)** - это индикатор, разработанный Джоном Боллинджером как дополнение к индикатору полосы Боллинджера. BBP показывает местоположение цены относительно верхней и нижней полос Боллинджера.
...
![График индикатора BBP](../../../../images/indicator_bollinger_percent_b.png)
