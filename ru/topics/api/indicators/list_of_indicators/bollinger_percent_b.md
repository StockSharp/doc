...
**Bollinger %b (Bollinger Percent B, BBP)** - это индикатор, разработанный Джоном Боллинджером как дополнение к индикатору полосы Боллинджера. BBP показывает местоположение цены относительно верхней и нижней полос Боллинджера.
