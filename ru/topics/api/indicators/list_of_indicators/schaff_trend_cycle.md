...
**Цикл тренда Шаффа (STC)** - это индикатор импульса, разработанный Дугом Шаффом. STC основан на предположении, что рыночные циклы чаще движутся между перекупленными и перепроданными условиями, чем в реальном тренде.
