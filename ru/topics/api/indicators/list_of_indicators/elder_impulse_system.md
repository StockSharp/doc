...
3. Определение цветовой классификации для текущей свечи:
   ```
   Если EMA[текущий] > EMA[предыдущий] И гистограмма MACD[текущий] > гистограмма MACD[предыдущий], то Зеленый (Бычий импульс)
   Если EMA[текущий] < EMA[предыдущий] И гистограмма MACD[текущий] < гистограмма MACD[предыдущий], то Красный (Медвежий импульс)
...
![График индикатора EIS](../../../../images/indicator_elder_impulse_system.png)
