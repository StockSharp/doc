...
**Индекс положительного объёма (индекс положительного объема, PVI)** - технический индикатор, разработанный Полом Дизартом, который фокусируется на изменениях цены в дни, когда объём торгов растёт по сравнению с предыдущим днём.
...
PVI часто используется вместе с дополнительным индикатором - индекс отрицательного объема (NVI), который, напротив, учитывает только те дни, когда объём уменьшается.
...
![График индикатора PVI](../../../../images/indicator_positive_volume_index.png)
