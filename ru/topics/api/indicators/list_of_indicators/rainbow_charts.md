...
**Радужные графики (радужные графики, RC)** - это индикатор технического анализа, который представляет собой набор скользящих средних с разными периодами, отображаемых на одном графике. Визуально индикатор напоминает радугу, отсюда и его название.
