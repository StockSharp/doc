...
**Осциллятор центра тяжести (CGO)** - это технический индикатор, разработанный Джоном Элерсом, который основывается на концепции центра тяжести в физике и применяет ее к анализу ценового движения на рынке.
...
![График индикатора CGO](../../../../images/indicator_center_of_gravity_oscillator.png)
