...
**Индекс разницы (индекс расхождения, DPI)** - это технический индикатор, который измеряет относительное отклонение текущей цены от скользящей средней за определенный период, выраженное в процентах.
...
![График индикатора DPI](../../../../images/indicator_disparity_index.png)
