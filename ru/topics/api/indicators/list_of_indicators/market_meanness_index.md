...
**Индекс злобы рынка (Индекс рыночной непредсказуемости, MMI)** - это технический индикатор, разработанный для определения, находится ли рынок в трендовом или боковом (хаотичном) состоянии.
...
5. **Фильтрация сигналов**:
   - MMI часто используется как фильтр для других индикаторов:
     ...
     - Сигналы осцилляторов (RSI, Стохастик) более надежны при высоком MMI

6. **Комбинирование с другими индикаторами**:
   - MMI хорошо работает в сочетании с ADX (средний направленный индекс)
...
![График индикатора MMI](../../../../images/indicator_market_meanness_index.png)
