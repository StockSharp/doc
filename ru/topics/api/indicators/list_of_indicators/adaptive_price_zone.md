...
**Адаптивная ценовая зона (адаптивная ценовая зона, APZ)** - это технический индикатор, разработанный Ли Лейбфарбом, который создает динамические зоны поддержки и сопротивления, адаптируясь к волатильности рынка.
...
![График индикатора APZ](../../../../images/indicator_adaptive_price_zone.png)
