...
**Средневзвешенная по времени цена (TWAP)** - это индикатор, который рассчитывает среднюю цену финансового инструмента, взвешенную по времени, в течение определенного периода. TWAP широко используется институциональными инвесторами для исполнения крупных ордеров с минимальным влиянием на рынок.
...
![График индикатора TWAP](../../../../images/indicator_time_weighted_average_price.png)
