...
**Композитный моментум (составной моментум, CM)** - это индикатор, который объединяет несколько методов измерения импульса цены для получения более надежных сигналов о силе и направлении тренда.
...
![График индикатора CM](../../../../images/indicator_composite_momentum.png)
