...
**Довольно хороший осциллятор (довольно хороший осциллятор, PGO)** - это технический индикатор, разработанный Марком Джонсоном, который сравнивает текущую цену закрытия с предыдущими, учитывая волатильность, чтобы определить перекупленность или перепроданность рынка.
...
Название "довольно хороший осциллятор" (Довольно хороший осциллятор) отражает прагматичный подход его создателя - индикатор не претендует на звание идеального инструмента, но предлагает "довольно хороший" способ оценки текущей рыночной ситуации.
...
1. Определение наивысшего максимума (наивысший максимум) и наинизшего минимума (наинизший минимум) за заданный период:
   ```
   наивысший максимум = Highest(High, Length)
   наинизший минимум = Lowest(Low, Length)
   ```
...
3. Расчет Довольно хорошего осциллятора:
   ```
   PGO = (Close - (наивысший максимум + наинизший минимум) / 2) / стандартное отклонение
   ```
...
![График индикатора PGO](../../../../images/indicator_pretty_good_oscillator.png)
