...
**Скользящее среднее Арно Легу (ALMA)** - это индикатор, разработанный Арно Легу и оптимизированный для устранения рыночного шума и снижения задержки сигнала.
...
![График индикатора ALMA](../../../../images/indicator_arnaud_legoux_moving_average.png)
