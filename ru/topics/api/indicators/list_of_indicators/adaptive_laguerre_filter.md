...
**Адаптивный фильтр Лагерра (адаптивный фильтр Лагерра, ALF)** - это индикатор, разработанный для сглаживания ценовых данных с минимальным запаздыванием, основанный на математических принципах фильтра Лагерра.
...
![График индикатора ALF](../../../../images/indicator_adaptive_laguerre_filter.png)
