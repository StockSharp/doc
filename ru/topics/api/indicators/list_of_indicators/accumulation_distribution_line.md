...
**Линия накопления/распределения (ADL)** - это индикатор объема, который был разработан Марком Чайкиным. Индикатор оценивает соотношение спроса и предложения на рынке путем анализа взаимосвязи цены и объема.
...
**1. Расчет множителя объема (CLV - значение положения закрытия):**
```
