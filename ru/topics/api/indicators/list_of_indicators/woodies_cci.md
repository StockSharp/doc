...
**Woodies CCI (WCCI)** - это модификация стандартного индекса товарного канала (индекс товарного канала, CCI), разработанная трейдером Кеном Вудом (известным как "Woodies"). Эта вариация CCI включает в себя дополнительное сглаживание и используется как часть комплексной торговой системы Woodies CCI.
