...
**Осциллятор пика Кейс (осциллятор пиков Кэйса, KPO)** - это технический индикатор, разработанный Селией Кейс, который сочетает импульс и волатильность для определения потенциальных пиков и впадин на рынке.
...
3. Расчет текущей волатильности:
   ```
   волатильность = ATR(ShortPeriod)
   ```

4. Нормализация импульса относительно волатильности:
   ```
   нормализованный краткосрочный моментум = краткосрочный моментум / волатильность
   нормализованный долгосрочный моментум = долгосрочный моментум / волатильность
   ```
...
![График индикатора KPO](../../../../images/indicator_kase_peak_oscillator.png)
