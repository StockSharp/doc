...
**Индикатор объема баланса (балансовый объем, BV)** - это технический индикатор, который отслеживает накопление и распределение объема торгов, основываясь на изменении цены.
...
Расчет индикатора балансовый объем основан на сравнении цены закрытия с предыдущей ценой закрытия и взвешивании объема торгов:
...
- BV(предыдущий) - предыдущее значение индикатора балансовый объем
...
![График индикатора BV](../../../../images/indicator_balance_volume.png)
