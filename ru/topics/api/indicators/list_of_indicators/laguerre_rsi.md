...
Расчет RSI Лагерра включает несколько этапов:
...
RSI Лагерра интерпретируется аналогично традиционному RSI, но с учетом его повышенной чувствительности:
...
![График индикатора LRSI](../../../../images/indicator_laguerre_rsi.png)
