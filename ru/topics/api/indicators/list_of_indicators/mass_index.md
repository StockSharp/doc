...
**Индекс массы (MI)** - это технический индикатор, разработанный Дональдом Дорси, который идентифицирует потенциальные развороты тренда, анализируя расширение и сжатие диапазона цен.
...
1. Расчет диапазона максимум-минимум для каждого периода:
   ```
   Range = High - Low
   ```
...
![График индикатора MI](../../../../images/indicator_mass_index.png)
