...
**Лента скользящих средних (MAR)** - это технический индикатор, который отображает несколько скользящих средних с последовательно увеличивающимися периодами для визуализации силы и направления тренда.
...
![График индикатора MAR](../../../../images/indicator_moving_average_ribbon.png)
