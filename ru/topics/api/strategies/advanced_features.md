...
При значении `Name` и имени стратегии "Пересечение SMA" каждая заявка получит комментарий "Пересечение SMA", что позволит отфильтровать заявки этой стратегии в журнале сделок.
