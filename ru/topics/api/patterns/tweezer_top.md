...
Вершина пинцета - это медвежий разворотный свечной паттерн, состоящий из двух свечей, который формируется в восходящем тренде. Характерной особенностью паттерна является то, что обе свечи имеют одинаковый или почти одинаковый максимум, напоминая пинцет с двумя одинаковыми концами.
...
![Паттерн вершина пинцет](../../../images/tweezertoppattern.png)

### Интерпретация

Вершина пинцета считается сигналом потенциального разворота восходящего тренда:
...
Вершина пинцета требует осторожного подхода и часто дополнительного подтверждения:
...
[Паттерн Дно пинцета](tweezer_bottom.md)

[Паттерн Вечерняя звезда](evening_star.md)
