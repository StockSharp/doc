# Паттерн Просвет в облаках (Пробивающий паттерн)

Просвет в облаках (Пробивающий паттерн) - это бычий разворотный свечной паттерн, состоящий из двух свечей, который формируется в нисходящем тренде. Первая свеча черная (медвежья), за которой следует белая (бычья) свеча, открывающаяся ниже минимума предыдущей свечи и закрывающаяся выше середины тела предыдущей свечи.
...
![Паттерн просвет в облаках](../../../images/piercingpattern.png)

### Интерпретация

Просвет в облаках считается надежным сигналом потенциального разворота нисходящего тренда:
...
- Если цена закрытия второй свечи выше цены открытия первой свечи, паттерн переходит в категорию "Бычье поглощение", что считается еще более сильным сигналом.

### Торговые стратегии

Просвет в облаках предоставляет хорошие возможности для входа в длинную позицию:
...
[Паттерн Бычье поглощение](bullish_engulfing.md)