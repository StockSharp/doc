# Паттерн Бычий харами

Бычий харами - это свечной паттерн разворота, состоящий из двух свечей, который формируется в нисходящем тренде. Термин "харами" происходит от японского слова, означающего "беременность", поскольку маленькая свеча (ребенок) содержится внутри большой свечи (матери).
...
Бычий харами сигнализирует о потенциальном завершении нисходящего тренда:
...
- Этот паттерн часто рассматривается как более слабый сигнал по сравнению с Бычье поглощение, но может быть более ранним индикатором возможного разворота.

### Торговые стратегии

Бычий харами обычно требует дополнительного подтверждения для входа в позицию:
...
[Паттерн Медвежий харами](bearish_harami.md)
