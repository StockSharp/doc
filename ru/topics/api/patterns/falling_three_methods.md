# Паттерн Падающие три метода

Падающие три метода - это медвежий паттерн продолжения тренда, состоящий из пяти свечей, который формируется в нисходящем тренде. Этот паттерн показывает временную консолидацию или отдых в рамках существующего нисходящего тренда перед его продолжением.

##### Ключевые особенности:

- Первая свеча черная (медвежья) с ценой открытия выше цены закрытия (O > C) и длинным телом.
- Следующие три свечи белые (бычьи) с ценой открытия ниже цены закрытия (O < C), с небольшими телами: (B < pB * 0.5m), (B < ppB * 0.5m), (B < pppB * 0.5m).
- Тела трех средних свечей не выходят за пределы диапазона первой свечи.
- Пятая свеча черная (медвежья) с ценой открытия выше цены закрытия (O > C) и длинным телом (B > pB * 2).
...
Падающие три метода считается надежным сигналом продолжения нисходящего тренда:
...
Падающие три метода предоставляет хорошие возможности для входа или усиления коротких позиций:
...
[Паттерн Восходящие три метода](rising_three_methods.md)

[Паттерн Три черные вороны (Три черных вороны)](three_black_crows.md)
