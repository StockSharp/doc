...
Стрекоза - это свечной паттерн, который характеризуется равенством цены открытия и закрытия, отсутствием верхней тени и длинной нижней тенью. Свеча напоминает форму буквы "T", что и дало ей название "стрекоза".
...
- Длинная нижняя тень.
- Похож на Молот, но с нейтральным телом (doji).

![Паттерн стрекоза](../../../images/dragonflypattern.png)

### Интерпретация

Стрекоза Doji считается потенциальным сигналом разворота, особенно в нисходящем тренде:
...
- В отличие от обычного Молот, равенство цен открытия и закрытия (doji) указывает на более выраженное равновесие сил.
