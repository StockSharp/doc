...
1. **Начинайте с режима только для чтения** — сначала реализуйте подключение, инструменты и рыночные данные. Торговые операции добавляйте после проверки
...
5. **Обрабатывайте пограничные случаи** — переподключение, изменение инструментов, нестандартные типы заявок
