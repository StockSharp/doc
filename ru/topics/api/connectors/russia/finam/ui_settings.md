# Графическое конфигурирование Finam History
...
![Настройки API GUI Finam History](../../../../../images/api_gui_settings_finam.png)

- **Инициатор сделки** \- Инициатор сделки (продавец или покупатель).
