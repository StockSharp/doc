# Графическое конфигурирование: J-Quants
...
Остальные свойства задаются в расширенном режиме и описаны на странице [Настройки коннектора](configuration_jquants.md). Не меняйте заполненные адреса провайдера, если он не выдал другие значения.
