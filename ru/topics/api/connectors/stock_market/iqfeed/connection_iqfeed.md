...
Подключение к серверам IQ производится с помощью приложения IQConnect, которое может быть установлено как на локальном компьютере, так и на удаленном. Обмен данными между клиентским приложением и IQConnect, а также между IQConnect и серверами производится посредством протокола TCP\/IP. 
