# Графическое конфигурирование: Rupeezy
...
Остальные свойства задаются в расширенном режиме и описаны на странице [Настройки коннектора](configuration_rupeezy.md). Не меняйте заполненные адреса провайдера, если он не выдал другие значения.
