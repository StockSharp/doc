...
**Morningstar Direct Web Services** - коннектор для получения рыночных данных от поставщика.
...
> [!CAUTION]
> Коннектор предоставляет рыночные данные и не поддерживает отправку заявок.
