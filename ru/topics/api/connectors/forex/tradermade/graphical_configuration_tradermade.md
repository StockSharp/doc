# Графическое конфигурирование: TraderMade
...
Остальные свойства задаются в расширенном режиме и описаны на странице [Настройки коннектора](configuration_tradermade.md). Не меняйте заполненные адреса провайдера, если он не выдал другие значения.
