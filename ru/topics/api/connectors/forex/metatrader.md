...
6. В меню Сервис -> Настройки выбрать вкладку **Советники** и убедиться, что включено разрешение для торговли внешним dll (**Разрешить импорт DLL**):

   ![Снимок экрана: MetaTrader 1](../../../../images/mt_1.png)

7. В случае, если при установке коннектора (пункт 2) терминал был запущен, то необходимо обновить список экспертов, нажав правой кнопкой на Эксперты и выбрав в меню **Обновить**:

   ![Снимок экрана: MetaTrader 2](../../../../images/mt_2.png)

8. Выбираем S\# эксперт, нажимаем правую кнопку и выбираем в меню пункт **Присоединить к графику**:
    
   ![Снимок экрана: MetaTrader 3](../../../../images/mt_3.png)
...
10. На графике (выбирается первый попавшийся) справа вверху должна появится иконка смайлика:
    ...
    ![Снимок экрана: MetaTrader 4](../../../../images/mt_4.png)
...
11. Если не получена лицензия MT4 или MT5, то в логе появится похожая на следующую строка:
    ...
    ![Снимок экрана: MetaTrader 5](../../../../images/mt_5.png)
...
12. Подключение к МТ идет по FIX протоколу, и используется коннектор [FIX протокол](../common/fix_protocol.md). В качестве демонстрации использована программа [Terminal](../../../terminal.md). Ниже настройки для транзакционного подключения и подключения с маркет\-данными (в случае MT5 порт по\-умолчанию равен 23001 вместо 23000):
    ...
    ![Снимок экрана: MetaTrader 6](../../../../images/mt_6.png)![Снимок экрана: MetaTrader 7](../../../../images/mt_7.png)
