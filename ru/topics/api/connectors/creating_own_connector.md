...
1. Опубликовать его в [StockSharp Store](https://stocksharp.com/ru/store) — платно или бесплатно. В этом случае установка на компьютеры пользователей будет выполняться автоматически через [Инсталлер](../../installer/setup.md).
