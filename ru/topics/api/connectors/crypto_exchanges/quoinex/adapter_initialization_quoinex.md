> [!CAUTION]
> **Биржа QUOINEX была переименована в Liquid, которая впоследствии прекратила работу. Коннектор больше не работает; документация сохранена только для справки.**
