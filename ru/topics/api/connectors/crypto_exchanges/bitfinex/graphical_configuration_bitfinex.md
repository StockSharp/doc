# Графическое конфигурирование Bitfinex
...
![Настройки GUI API Bitfinex](../../../../../images/api_gui_settings_bitfinex.png)
...
- **Отмена при отключении** \- отменять активные заявки при разрыве соединения.
