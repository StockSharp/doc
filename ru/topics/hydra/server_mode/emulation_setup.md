...
![Снимок экрана: Настройки эмуляции 1](../../../images/hydra_emulator_start.png)
...
- ВАЖНО! При включённом режиме все заявки и сделки эмулируются в реальном времени. При выключенном режиме действия отправляются на реальный рынок.

Этот режим используется при [тестировании стратегий](../../shell/user_interface/emulation.md).

## Настройки эмуляции.

![Снимок экрана: Настройки эмуляции 2](../../../images/hydra_emulator_prop.png)
