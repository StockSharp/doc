...
1. Первый шаг \- создание **Индекса**. Для этого необходимо нажать на вкладке **Все инструменты.** кнопку **Создать инструмент\=\>Индекс** ![hydra индекс инструментов 00](../../../images/hydra_index_sec_00.png)
2. После чего появится окно следующего вида:![hydra индекс инструментов](../../../images/hydra_index_sec.png)
...
4. Записываем математическую операцию, на основе которой будет вычисляться индекс.![hydra индекс инструментов 01](../../../images/hydra_index_sec_01.png)
5. Далее, необходимо нажать кнопку [Свечи](../working_with_data/view_and_export/candles.md) на вкладке **Общее**, выбрать полученный инструмент **Индекс**, период данных, в поле **Построить из:** установить значение **Составной элемент**. После чего нажать кнопку![Hydra кнопка поиска](../../../images/hydra_find.png).![hydra индекс свечей](../../../images/hydra_index_candle.png)
