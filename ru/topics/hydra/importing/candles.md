...
![Hydra импорт свечей](../../../images/hydra_import_candles.png)
...
2. **Настроить параметры импорта для полей**[S\#](../../api.md).
   ...
   - **Порядок** \- последовательность расположения столбцов свойств импортируемого элемента.
    ...
    То ему будет соответствовать следующая настройка:![Hydra свойства импорта свечей](../../../images/hydra_import_prop_candles.png)
...
3. Для предварительного просмотра данных, нажать кнопку **Предпросмотр**.![Hydra предпросмотр импорта свечей](../../../images/hydra_import_preview_candles.png)
