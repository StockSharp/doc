...
![Снимок экрана: Лог заявок 1](../../../images/hydra_import_orderlog.png)
...
2. Настроить параметры импорта для полей [S\#](../../api.md).
   ...
   **Рассмотрим пример импорта Лог заявок из CSV файла:**
   ...
   - Окно настройки полей будет выглядеть следующим образом:![Снимок экрана: Лог заявок 2](../../../images/hydra_import_prop_orderlog.png)
...
3. Для предварительного просмотра данных нажать кнопку **Предпросмотр**.![Снимок экрана: Лог заявок 3](../../../images/hydra_import_preview_orderlog.png)
