...
![Снимок экрана: Стаканы](../../../images/hydra_import_depths.png)
...
2. Настроить параметры импорта для полей [S\#](../../api.md).
   ...
   **Рассмотрим пример импорта стакана из CSV файла:**
   ...
   - Окно настройки полей будет выглядеть следующим образом:![Hydra свойства импорта стакана](../../../images/hydra_import_prop_depth.png)
...
3. Для предварительного просмотра данных нажать кнопку **Предпросмотр**.![Hydra предпросмотр импорта стакана](../../../images/hydra_import_preview_depth.png)
