...
2. Настроить параметры импорта для полей [S\#](../../api.md).
   ...
   **Рассмотрим пример импорта данных Level 1 из CSV файла:**
   ...
   - Окно настройки полей будет выглядеть следующим образом:![hydra import prop панель Level 1](../../../images/hydra_import_prop_level1.png)
...
3. Для предварительного просмотра данных нажать кнопку **Предпросмотр**.![hydra import preview панель Level 1](../../../images/hydra_import_preview_level1.png)
