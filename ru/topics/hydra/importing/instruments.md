...
![Снимок экрана: Инструменты 1](../../../images/hydra_import_securities.png)
...
2. Настроить параметры импорта для полей [S\#](../../api.md).
   ...
   **Рассмотрим пример импорта инструмента из CSV файла:**
   ...
   - Окно настройки полей будет выглядеть следующим образом:![Снимок экрана: Инструменты 2](../../../images/hydra_import_prop_securitiy.png)
...
3. Для предварительного просмотра данных нажать кнопку **Предпросмотр**.![Снимок экрана: Инструменты 3](../../../images/hydra_import_preview_securitiy.png)
