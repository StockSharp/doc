...
![hydra импорт сделок](../../../images/hydra_import_trades.png)
...
2. Настроить параметры импорта для полей [S\#](../../api.md).
   ...
   **Рассмотрим пример импорта сделок(тиков) из CSV файла:**
   ...
   - Окно настройки полей будет выглядеть следующим образом:![hydra свойства импорта сделок](../../../images/hydra_import_prop_trade.png)
...
3. Для предварительного просмотра данных нажать кнопку **Предпросмотр**.![hydra предпросмотр импорта сделок](../../../images/hydra_import_preview_trade.png)
