...
![Снимок экрана: Просмотр маркет\-данных 1](../../../images/hydra_view_export.png)

Каждая панель имеет общий интерфейс настроек следующего вида:

![Hydra экспорт 00](../../../images/hydra_export_00.png)
...
- Если при построении таблицы с данными количество загружаемых данных будет превышать установленный лимит, то на экране появится окно:![Снимок экрана: Просмотр маркет\-данных 2](../../../images/hydra_tick_limit.png)

  Нужно увеличить лимит загружаемых данных.
- Если данные были получены из источников, чей часовой пояс не совпадает с текущим часовым поясом, то можно настроить временной пояс. Тогда, после построения, полученные данные будут иметь время выбранного пользователем пояса. ![Снимок экрана: Просмотр маркет\-данных 3](../../../images/hydra_tz.png)
...
- После того как выбраны указанные выше параметры, необходимо нажать на кнопку ![Hydra кнопка поиска](../../../images/hydra_find.png).![Hydra таймфрейм свечей](../../../images/hydra_candles_tf.png)
...
![Hydra контекст экспорта](../../../images/hydra_export_context.png)
