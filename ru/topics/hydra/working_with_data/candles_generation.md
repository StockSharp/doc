...
2. В открывшемся окне необходимо настроить параметры генерации свечей:
   ...
   - Нажмите на кнопку ![Hydra кнопка поиска](../../../images/hydra_find.png) для запуска генерации
...
3. Для вывода индикатора на отдельной панели:
   - Добавьте новую панель при помощи кнопки ![Hydra кнопка добавления](../../../images/hydra_add.png)
