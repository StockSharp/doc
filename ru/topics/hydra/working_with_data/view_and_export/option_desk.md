...
В появившемся окне выбрать нужный диапазон времени, базовый актив, добавить опционы по базовому активу и нажать кнопку ![Hydra кнопка поиска](../../../../images/hydra_find.png):
...
![Снимок экрана: Доска опционов](../../../../images/hydra_option_desk.png)
