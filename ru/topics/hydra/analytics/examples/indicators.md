...
![Индикаторы](../../../../images/hydra_analytics_indicator.png)
...
- **Полосы Боллинджера (BB)**: Показывают диапазон и волатильность цен, базируясь на скользящих средних и стандартных отклонениях.
