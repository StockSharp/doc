...
1. Добавляем инструменты.
   ...
   Для добавления инструмента щелкаем на кнопку **Добавить** ![Hydra кнопка добавления](../../images/hydra_add.png). После чего откроется окно для скачивания инструментов.![hydra securities](../../images/hydra_securities.png)
...
2. У каждого выбранного инструмента надо выбрать необходимые для скачивания типы маркет\-данных.
   ...
   Если не установлены все необходимые параметры инструмента, то в левой колонке строки с инструментом появится значок ![hydra zero](../../images/hydra_zero.png). ![hydra выбор типа маркет-данных](../../images/hydra_type_market_data_choose.png)
