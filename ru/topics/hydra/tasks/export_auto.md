...
![Hydra задачи экспорта](../../../images/hydra_tasks_export.png)
...
![Снимок экрана: Экспорт (авто)](../../../images/hydra_tasks_connstring.png)
...
- **Рабочее время** \- настройка работы площадки. ![Hydra задачи резервного копирования](../../../images/hydra_tasks_backup_desk.png)
...
2. Устанавливаем маркет данные которые необходимо экспортировать.![Hydra задачи экспорта 00](../../../images/hydra_tasks_export_00.png)
3. Устанавливаем период экспорта. Если настроено скачивание маркет данных в режиме реального времени, то можно не указывать дату окончания периода. В таком случае данные будут экспортироваться в режиме реального времени, в соответствии с интервалом работы (обновления данных). ![Hydra задачи экспорта 01](../../../images/hydra_tasks_export_01.png)
4. Настраиваем директории. Интервал работы. Тип данных. Формат данных.
5. Запускаем экспорт.![Hydra задачи экспорта 02](../../../images/hydra_tasks_export_02.png)

Просмотрим экспортированные данные.

![Hydra задачи экспорта 03](../../../images/hydra_tasks_export_03.png)
