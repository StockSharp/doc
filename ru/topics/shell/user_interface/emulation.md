...
![Shell эмуляция 00](../../../images/shell_emulation_00.png)

Нажав на кнопку **Добавить** ![Designer кнопка добавления 00](../../../images/designer_creation_tool_00.png) можно добавить стратегию для тестирования. Каждая добавленная стратегия открывается на индивидуальной вкладке.
