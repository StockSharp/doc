...
Для корректной работой с [AlfaDirectMessageAdapter](../api/StockSharp.AlfaDirect.AlfaDirectMessageAdapter.html) необходимо предварительно настроить торговый терминал [Альфа\-Директ](Alfa.md). 
