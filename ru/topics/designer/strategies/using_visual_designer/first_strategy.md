...
1. Создадим новую стратегию как описано в пункте [Использование кода](../using_code.md) из кубиков. Добавить новую стратегию можно нажав на кнопку Добавить ![Designer панель схем 01](../../../../images/designer_panel_circuits_01.png) во вкладке **Общие** и выбрать **Стратегия**. Или нажав правой кнопкой мыши на папке **Стратегии** панели **Схемы**, и нажать на кнопку Добавить ![Designer панель схем 01](../../../../images/designer_panel_circuits_01.png) в выпавшем меню.

![Designer создание стратегии 00](../../../../images/designer_creation_of_strategy_00.png)

После нажатия кнопки Добавить ![Designer панель схем 01](../../../../images/designer_panel_circuits_01.png) в папке **Стратегии** панели **Схемы** появится новая стратегия. В рабочей области появится новая вкладка со стратегией, при переходе на которую в ленте автоматически откроется вкладка **Эмуляция**. На вкладке **Эмуляция** можно изменить название стратегии и дать ей краткое описание.

![Designer создание стратегии 01](../../../../images/designer_creation_of_strategy_01.png)

2. Для удобной работы стоит раскрыть и зафиксировать панели **Палитра** и **Свойства** области **Схема**, нажав кнопку ![Designer алгоритм создания кубиков 13](../../../../images/designer_algorithm_creation_of_elements_13.png). В результате получится окно следующего вида.

![Designer алгоритм создания кубиков 00](../../../../images/designer_algorithm_creation_of_elements_00.png)
...
![Designer алгоритм создания кубиков 01](../../../../images/designer_algorithm_creation_of_elements_01.png)
...
![Designer алгоритм создания кубиков 02](../../../../images/designer_algorithm_creation_of_elements_02.png)

![Designer алгоритм создания кубиков 03](../../../../images/designer_algorithm_creation_of_elements_03.png)
...
![Designer алгоритм создания кубиков 04](../../../../images/designer_algorithm_creation_of_elements_04.png)
...
![Designer алгоритм создания кубиков 05](../../../../images/designer_algorithm_creation_of_elements_05.png)
...
![Designer алгоритм создания кубиков 06](../../../../images/designer_algorithm_creation_of_elements_06.png)
...
![Designer алгоритм создания кубиков 07](../../../../images/designer_algorithm_creation_of_elements_07.png)
...
![Designer алгоритм создания кубиков 08](../../../../images/designer_algorithm_creation_of_elements_08.png)
...
![Designer алгоритм создания кубиков 09](../../../../images/designer_algorithm_creation_of_elements_09.png)
...
![Designer алгоритм создания кубиков 10](../../../../images/designer_algorithm_creation_of_elements_10.png)
...
![Designer алгоритм создания кубиков 11](../../../../images/designer_algorithm_creation_of_elements_11.png)
...
![Designer алгоритм создания кубиков 12](../../../../images/designer_algorithm_creation_of_elements_12.png)
