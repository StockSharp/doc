...
![Designer защита позиций 00](../../../../../../images/designer_protect_positions_00.png)

![Designer защита позиций 01](../../../../../../images/designer_protect_positions_01.png)
...
![Designer защита позиций 02](../../../../../../images/designer_protect_positions_02.png)

> [!WARNING]
> Входящими сделками НЕ могут быть сделки всей стратегии (кубик [Сделки стратегии](../common/trades_by_strategy.md)) так как это приведет к неправильному расчету текущей позиции: сделки защиты также окажутся сделками стратегии. На вход **Защиты позиции** следует подавать сделки, полученные из исходящего сокета **Сделка** кубиков [Регистрация заявки](../orders/register.md) и [Изменить позицию](modify.md), либо аналогичных элементов, непосредственно изменяющих позицию.
