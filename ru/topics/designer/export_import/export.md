...
![Designer экспорт стратегий 00](../../../images/designer_export_strategies_00.png)

После нажатия **Экспорт** в зависимости от типа контента появится окно:

- для [схемы](../strategies/using_visual_designer.md):

  ![Designer экспорт стратегий 01](../../../images/designer_export_strategies_01.png)
...
- для [кода](../strategies/using_code.md):
  ...
  ![Designer экспорт стратегий 02](../../../images/designer_export_strategies_02.png)
