...
![Designer быстрый старт 01](../../images/designer_quick_start_01.png)
...
![Designer быстрый старт 02 (1)](../../images/designer_quick_start_02.png)

При нажатии на кнопку ![Designer кнопка редактирования](../../images/designer_edit_tool_00.png) появится окно **Параметры хранилища данных**, позволяющее настроить как локальное, так и удаленное хранилище. Также возможна настройка подключения  [Hydra](../hydra.md) [в серверном режиме](../hydra/server_mode/settings.md), как источника маркет-данных. При нажатии на **кнопку выбора хранилища** открывается окно выбора папки. В нем необходимо выбрать ту в которую ранее вы сохранили скачанную  [Hydra](../hydra.md) историю.
...
![Designer быстрый старт 02 (2)](../../images/designer_quick_start_03.png)
...
![Designer быстрый старт 03](../../images/designer_quick_start_04_1.png)
...
Нажав на значок ![Designer быстрый старт 04](../../images/designer_quick_start_04.png) в поле **Инструмент** откроется окно **Выбор инструмента**. В этом окне необходимо выбрать требуемый инструмент.

![Designer быстрый старт 05](../../images/designer_quick_start_05.png)

Выбрав любой блок на панели **Дизайнер**, в панели **Свойства** появятся свойства этого блока. В панели **Свойства** блока **Свечи** можно настроить тип и таймфрейм свечей ([Свечи](../api/candles.md)).
...
![Designer быстрый старт 06](../../images/designer_quick_start_06.png)
