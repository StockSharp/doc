...
![Публикация своей стратегии 00](../../../images/designer_publish_00.png)
...
![Публикация своей стратегии 01](../../../images/designer_publish_01.png)

Обязательными к заполнению поля являются:

- Название
- Описание
- Идентификатор Nuget пакета. Данный параметр нужен для задания ссылки на продукт в магазине. Например, в адресе https://stocksharp.com/ru/store/runner/ слово **runner** задается через данный параметр.
...
![Публикация своей стратегии 02](../../../images/designer_publish_02.png)

После нажатия на кнопку **ОК**, будет показано окно об успешном обновлении:

![Публикация своей стратегии 03](../../../images/designer_publish_03.png)