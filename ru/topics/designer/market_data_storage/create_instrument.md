...
При нажатии на кнопку **Создать инструмент** ![Designer кнопка добавления 00](../../../images/designer_creation_tool_00.png) откроется окно **Редактирование**. Для создания инструмента необходимо заполнить свойства инструмента и нажать кнопку **ОК**:

![Designer кнопка добавления 01](../../../images/designer_creation_tool_01.png)
