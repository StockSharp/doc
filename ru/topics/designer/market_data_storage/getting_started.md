...
Создать хранилище исторических данных можно, нажав на кнопку ![Designer создание хранилища исторических данных 00](../../../images/designer_creating_repository_of_historical_data_00.png) вкладки **Маркет\-данные**. Нажав на кнопку ![Designer создание хранилища исторических данных 01](../../../images/designer_creating_repository_of_historical_data_01.png), можно изменить параметры текущего хранилища. Нажав на кнопку ![Designer создание хранилища исторических данных 02](../../../images/designer_creating_repository_of_historical_data_02.png), можно удалить из списка хранилищ текущее хранилище.

![Designer создание хранилища исторических данных 03](../../../images/designer_creating_repository_of_historical_data_03.png)
...
![Designer создание хранилища исторических данных 04](../../../images/designer_creating_repository_of_historical_data_04.png)

После чего в [Designer](../../designer.md), нажав на кнопку ![Designer создание хранилища исторических данных 00](../../../images/designer_creating_repository_of_historical_data_00.png), добавить новое хранилище. В настройках хранилища в поле адрес указываем «net.tcp:\/\/localhost:8000». Нажать ОК. При использовании [Hydra](../../hydra.md) в качестве удаленного хранилища не стоит забывать, что [Hydra](../../hydra.md) должна быть запущена и настроена соответствующим образом.

![Designer создание хранилища исторических данных 05](../../../images/designer_creating_repository_of_historical_data_05.png)

После добавления нового хранилища, его можно выбрать в выпадающем списке **Хранилище**.

![Designer создание хранилища исторических данных 06](../../../images/designer_creating_repository_of_historical_data_06.png)
