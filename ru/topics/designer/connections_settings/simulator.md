...
1. При нажатии на стрелку возле кнопки **Подключиться** ![Designer панель быстрого доступа 00](../../../images/designer_quick_access_toolbar_00.png) появится кнопка **Настройки эмуляции**:
...
![Designer свойства эмуляции 00](../../../images/designer_properties_emulation_00.png)
