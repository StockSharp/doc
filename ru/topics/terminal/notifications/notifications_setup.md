...
Для задания уведомления необходимо на панели уведомлений ([Панель уведомлений](notification_panel.md)) нажать на кнопку ![Designer кнопка добавления 00](../../../images/designer_creation_tool_00.png) или нажать на кнопку ![Designer колокол уведомлений](../../../images/designer_alert_bell.png) непосредственно на панелях, поддерживающих уведомления ([Портфели](../user_interface/portfolios.md), [Лента сделок](../user_interface/components/trades_feed.md), [Новости](../user_interface/components/news.md), [Level 1](../user_interface/components/level_1.md)).
