...
4. Иногда Windows не запускает установку сразу, а выдает предупреждение:
   ...
   ![установщик ZIP: свойства (1)](../../images/installer_warn_1.png)

5.  В этом случае нажмите на ссылку **Подробнее** в окне предупреждения, после чего появится следующее окно:

    ![установщик ZIP: свойства (2)](../../images/installer_warn_2.png)
...
7.  При первой установке необходимо ввести логин и пароль **StockSharp**.
    ...
    ![установщик: вход](../../images/login_installer.png)
...
8. После входа откроется окно программы.![установщик: первое окно](../../images/first_win_installer.png)
