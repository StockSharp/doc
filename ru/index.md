...
[StockSharp (кратко S\#)](https://stocksharp.com/ru/store/) \- **бесплатные** программы для торговли на всех площадках мира (российские, американские, азиатские, акции, фьючерсы, опционы, биткоины, форекс и т.д.). Вы сможете торговать в ручном режиме или с помощью торговых роботов (обычные или HFT).

**Поддерживается более 90 брокеров, бирж и источников данных:** [Коннекторы](topics/api/connectors.md).
...
- Возможность делиться схемами стратегий с командой.
...
![Терминал: главное окно 00](images/terminal_main_00.png)

Преимущества и возможности Terminal:

1. **Подключение ко множеству торговых площадок** через [Коннекторы](topics/api/connectors.md).
...
[Shell](topics/shell.md) \- готовый графический каркас, который можно быстро адаптировать под свои нужды. Он поставляется с полностью открытым исходным кодом на языке C\#:

- Полный исходный код.
- Поддержка всех подключений платформы StockSharp: FIX\/FAST, криптовалютные биржи и другие.
- Поддержка схем Designer.
- Гибкий пользовательский интерфейс.
- Инструменты тестирования стратегий (статистика, эквити, отчёты).
- Сохранение и загрузка настроек стратегий.
- Одновременный запуск стратегий.
- Подробная информация о работе стратегий (заявки, сделки, позиции, прибыль, логи и другое).
...
- **Поддержка множества источников данных** через [Коннекторы](topics/api/connectors.md).
...
- [ЛЧИ Viewer](https://stocksharp.com/ru/products/lci/) \- графики конкурса ЛЧИ со сделками участников.

***[Скачать](https://stocksharp.com/ru/products/download/)***
