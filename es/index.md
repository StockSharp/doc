...
- Tareas programadas y sincronización automática por Internet entre instancias de Hydra en ejecución.
...
- Incluye varios tipos de velas: Volume, Tick, Range, Renko.
- Incluye gráficos de clúster y de cajas.

### Shell

Shell proporciona un marco gráfico ya preparado que puede personalizarse rápidamente según sus necesidades y que incluye código fuente completamente abierto en C#:

- Código fuente completo incluido.
- Compatible con todas las conexiones de la plataforma StockSharp: FIX/FAST, bolsas de criptomonedas (más de 30 actualmente), etc.
- Compatibilidad con esquemas de Designer.
...
[Materiales de referencia](topics/common/reference_materials.md)
