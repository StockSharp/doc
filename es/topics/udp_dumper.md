...
2. Para añadir feeds de red, añádalos manualmente o cargue todos los feeds desde los archivos de configuración de la bolsa. Para ello, haga clic en el botón:![Captura de UDP Dumper 2](../images/dumper_2.png)
...
4. Todos los feeds con direcciones IP y configuración de puertos se cargarán desde un archivo:![Captura de UDP Dumper 4](../images/dumper_4.png)
5. Seleccione los feeds necesarios y haga clic en el botón de iniciar descarga:![Captura de UDP Dumper 5](../images/dumper_5.png)
6. Si la configuración es correcta, el programa comenzará a recibir datagramas UDP y a escribirlos en disco. La aplicación mostrará el número de bytes recibidos para cada feed:![Captura de UDP Dumper 6](../images/dumper_6.png)
