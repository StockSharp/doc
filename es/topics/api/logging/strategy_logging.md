...
## Logging en un archivo de prueba
...
1. Primero, necesita crear el administrador especial: 
   ...
   ```
2. Después necesita crear un logger de archivo, pasándole el nombre del archivo, y agregarlo a [LogManager.Listeners](xref:Ecng.Logging.LogManager.Listeners): 
...
3. Para registrar mensajes, debe agregar una estrategia a [LogManager.Sources](xref:Ecng.Logging.LogManager.Sources): 
   ...
   ```
4. Después de agregar la estrategia al administrador de logging, todos sus mensajes se registrarán en el archivo. 

## Reproducción de sonido

1. Cree un logger y pásele el nombre del archivo de sonido:
...
1. Cree el logger y pásele los parámetros de las cartas enviadas:
...
## Logging en LogWindow

1. Cree el logger [GuiLogListener](xref:StockSharp.Xaml.GuiLogListener):
