...
Luego importe los módulos ES: `import { renderScheme } from '@stocksharp/diagram/embed'` para la incrustación de solo lectura, o `import { StockSharpDiagram } from '@stocksharp/diagram'` para el [editor interactivo](diagram/editor.md).
...
El mismo componente también funciona como un **editor** completo: permite arrastrar elementos desde una paleta, conectar puertos, editar y eliminar nodos, y deshacer/rehacer. Consulte [Editor interactivo](diagram/editor.md) y [Eventos y API](diagram/events.md).

## Véase también

- [Editor interactivo](diagram/editor.md)
- [Eventos y API](diagram/events.md)
