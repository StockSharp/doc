...
**Dynamic Zones RSI (DZRSI)** es una modificación del clásico índice de fuerza relativa (RSI) que utiliza niveles de sobrecompra y sobreventa que cambian dinámicamente en lugar de niveles estáticos.
