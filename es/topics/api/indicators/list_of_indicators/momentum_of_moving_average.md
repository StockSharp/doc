...
- **Longitud** - período para el cálculo de la media móvil (valor predeterminado: 14)
- **Período de impulso** - período para el cálculo del impulso (valor predeterminado: 10)
