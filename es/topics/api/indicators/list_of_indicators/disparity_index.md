...
- Creación de estrategias de trading basadas en la reversión a la media.
...
1. **Niveles extremos**:
   - Los valores positivos de High (e.g., por encima de +10%) pueden indicar condiciones de sobrecompra en el mercado
   - Los valores negativos de High (e.g., por debajo de -10%) pueden indicar condiciones de sobreventa del mercado
