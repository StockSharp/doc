...
**Balance de poder del mercado (BMP)** es un indicador que mide la fuerza de los compradores en relación con los vendedores, basándose en un análisis de los movimientos de precios y los volúmenes de negociación.
...
El indicador Balance de poder del mercado está diseñado para evaluar la distribución actual de fuerzas entre compradores y vendedores en el mercado. Analiza cuánto se desvía el precio de cierre de su rango (máximo-mínimo) y lo correlaciona con el volumen de operaciones.
...
1. Calculando BMP para cada vela individual:
   ```
   BMP bruto = ((Precio de cierre - Precio de apertura) / (High - Low)) * Volume
   ```
...
donde:
- Precio de cierre - precio de cierre de la vela actual
- Precio de apertura - precio de apertura de la vela actual
...
![Gráfico del indicador BMP](../../../../images/indicator_balance_of_market_power.png)
