...
**Índice de flujo de aprobación (AFI)** es un indicador que mide la fuerza de la tendencia en función de la relación entre el volumen y el movimiento del precio.

Para utilizar el indicador, debe utilizar la clase [ApprovalFlowIndex](xref:StockSharp.Algo.Indicators.ApprovalFlowIndex).

## Descripción

El índice de flujo de aprobación (AFI) ayuda a evaluar la intensidad del flujo de órdenes en el mercado y determinar la fuerza de la tendencia actual. Este indicador analiza la relación entre el volumen de operaciones y el movimiento de precios para identificar posibles puntos de reversión o confirmar la continuación de la tendencia.

El indicador AFI se puede utilizar para:
- Determinar la fuerza de la tendencia actual
- Identificar divergencias entre el precio y el indicador
- Buscar posibles puntos de reversión del mercado

## Parámetros

El indicador tiene los siguientes parámetros:
- **Longitud** - período de cálculo del indicador

## Cálculo

El cálculo del índice de flujo de aprobación se basa en el análisis de la variación de precios y el volumen durante un período específico:
...
AFI busca determinar en qué medida el volumen de operaciones "confirma" el movimiento del precio.
...
![Gráfico del indicador AFI](../../../../images/indicator_approval_flow_index.png)
