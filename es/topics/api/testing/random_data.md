...
Las pruebas con datos aleatorios son un tipo especial de testing. No están pensadas para buscar parámetros óptimos. En cambio, permiten detectar errores en el código exponiendo el algoritmo de negociación a distintos escenarios de bolsa.
...
Para estos y muchos otros escenarios del funcionamiento de la bolsa que es imposible prever de antemano, [S#](../../api.md) proporciona pruebas con datos aleatorios, capaces de generar el máximo número de condiciones en un intervalo corto debido a su unicidad uniforme.
