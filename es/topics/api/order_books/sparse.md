...
3. **Planificación estratégica:** Comprender la estructura del libro de órdenes permite planificar operaciones de negociación con mayor precisión, considerando posibles "vacíos" de liquidez.
...
- `priceStep` - el paso de precio del instrumento de negociación. Se usa en caso de que `priceRange` tenga menor precisión en niveles de precio que `priceStep` y necesite redondear los precios obtenidos al paso de precio del instrumento.
