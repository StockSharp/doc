...
const bb = compute(BollingerBandsIndicator, { length: 20, stdDev: 2 }, candles);   // salidas: upper, middle, lower
...
const macd = compute(MacdIndicator, { fastLength: 12, slowLength: 26, signalLength: 9 }, candles);   // salidas: macd, signal, histogram
