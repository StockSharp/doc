...
1. Durante el trabajo de una estrategia de trading, cuando es necesario guardar el estado (órdenes, posiciones, ajustes, etc.);
2. Guardado de datos de mercado desde el terminal de trading para probar algoritmos en tiempo real;
