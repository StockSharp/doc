...
El **conector de BCS** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de BCS, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](bcs/configuration_bcs.md)

[Configuración gráfica](bcs/graphical_configuration_bcs.md)

[Inicialización del adaptador](bcs/adapter_initialization_bcs.md)
