...
El **conector de Tradernet** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Tradernet, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](tradernet/configuration_tradernet.md)

[Configuración gráfica](tradernet/graphical_configuration_tradernet.md)

[Inicialización del adaptador](tradernet/adapter_initialization_tradernet.md)
