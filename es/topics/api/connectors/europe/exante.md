...
El **conector de EXANTE** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de EXANTE, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](exante/configuration_exante.md)

[Configuración gráfica](exante/graphical_configuration_exante.md)

[Inicialización del adaptador](exante/adapter_initialization_exante.md)
