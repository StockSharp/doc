...
![API GUI Settings Yobit](../../../../../images/api_gui_settings_yobit.png)

- **Key** - Clave.
- **Secret** - Secreto.
- **Balance** - Intervalo de comprobación del balance. Necesario en caso de operaciones de depósito y retiro.
- **Heartbeat** - Intervalo de comprobación del servidor para rastrear si la conexión está activa. Por defecto es igual a 1 minuto.
