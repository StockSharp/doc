# Configuración gráfica de BitMEX
...
![Configuración de API GUI BitMEX](../../../../../images/api_gui_settings_bitmex.png)

- **clave** - Clave.
- **secreto** - Secreto.
- **Demo** - Conectar al trading de demostración en lugar del servidor de trading real.
