...
**Historial de Kucoin** - servicio público de datos históricos de mercado de Kucoin.

Antes de comenzar a escribir robots de negociación para esta plataforma, recomendamos leer los enlaces de la sección [Conectores](../../connectors.md).

> [!CAUTION]
> El conector solo admite datos de mercado; las transacciones no son compatibles.
