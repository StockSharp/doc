...
El **conector de Trading Economics** conecta StockSharp con un servicio profesional de datos y análisis de mercado. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Trading Economics, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](trading_economics/configuration_trading_economics.md)

[Configuración gráfica](trading_economics/graphical_configuration_trading_economics.md)

[Inicialización del adaptador](trading_economics/adapter_initialization_trading_economics.md)
