...
El **conector de Zebu** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Zebu, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](zebu/configuration_zebu.md)

[Configuración gráfica](zebu/graphical_configuration_zebu.md)

[Inicialización del adaptador](zebu/adapter_initialization_zebu.md)
