...
El **conector de MasterLink** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de MasterLink, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](masterlink/configuration_masterlink.md)

[Configuración gráfica](masterlink/graphical_configuration_masterlink.md)

[Inicialización del adaptador](masterlink/adapter_initialization_masterlink.md)
