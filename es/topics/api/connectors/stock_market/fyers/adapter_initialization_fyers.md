# Inicialización del adaptador FYERS

El código siguiente muestra cómo inicializar [FyersMessageAdapter](xref:StockSharp.Fyers.FyersMessageAdapter) y pasarlo a [Connector](xref:StockSharp.Algo.Connector).
