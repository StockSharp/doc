...
El **conector de XBRL Filings** conecta StockSharp con un servicio de datos financieros e información de referencia. Traduce los datos específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo con distintas fuentes de datos.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de XBRL Filings, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](xbrl_filings/configuration_xbrl_filings.md)

[Configuración gráfica](xbrl_filings/graphical_configuration_xbrl_filings.md)

[Inicialización del adaptador](xbrl_filings/adapter_initialization_xbrl_filings.md)
