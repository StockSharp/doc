# Inicialización del adaptador: Fubon Neo

El código siguiente muestra cómo inicializar [FubonNeoMessageAdapter](xref:StockSharp.FubonNeo.FubonNeoMessageAdapter) y añadirlo a [Connector](xref:StockSharp.Algo.Connector).
