...
- **Identificador** - ID único. Se usa cuando varios clientes están conectados a un terminal o gateway.
- **Tiempo real** - Si deben usarse datos en tiempo real o datos "congelados" en el servidor del bróker.
...
- **Protocolo** - Protocolo SSL para establecer conexión
