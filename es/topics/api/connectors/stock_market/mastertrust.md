...
El **conector de Mastertrust** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Mastertrust, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](mastertrust/configuration_mastertrust.md)

[Configuración gráfica](mastertrust/graphical_configuration_mastertrust.md)

[Inicialización del adaptador](mastertrust/adapter_initialization_mastertrust.md)
