...
**ITCH** - proveedor de datos de mercado en tiempo real para cotizaciones de acciones, Forex, noticias, contratos de futuros, etc.
...
[Inicialización del adaptador ITCH](itch/adapter_initialization_itch.md)
