...
El **conector de JPX TDnet** conecta StockSharp con un servicio de datos financieros e información de referencia. Traduce los datos específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo con distintas fuentes de datos.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de JPX TDnet, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](jpx_tdnet/configuration_jpx_tdnet.md)

[Configuración gráfica](jpx_tdnet/graphical_configuration_jpx_tdnet.md)

[Inicialización del adaptador](jpx_tdnet/adapter_initialization_jpx_tdnet.md)
