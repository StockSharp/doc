...
**NinjaTrader** integra **API REST y WebSocket de NinjaTrader** con StockSharp para obtener datos de mercado y operar.
...
Antes de desarrollar robots de negociación para NinjaTrader, consulte los enlaces de la sección [Conectores](../../connectors.md).
