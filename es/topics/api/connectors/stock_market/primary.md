...
El **conector de Primary** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Primary, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](primary/configuration_primary.md)

[Configuración gráfica](primary/graphical_configuration_primary.md)

[Inicialización del adaptador](primary/adapter_initialization_primary.md)
