...
El **conector de Firstock** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Firstock, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](firstock/configuration_firstock.md)

[Configuración gráfica](firstock/graphical_configuration_firstock.md)

[Inicialización del adaptador](firstock/adapter_initialization_firstock.md)
