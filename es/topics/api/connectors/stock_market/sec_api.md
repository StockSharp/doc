...
El **conector de SEC API** conecta StockSharp con un servicio de datos financieros e información de referencia. Traduce los datos específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo con distintas fuentes de datos.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de SEC API, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](sec_api/configuration_sec_api.md)

[Configuración gráfica](sec_api/graphical_configuration_sec_api.md)

[Inicialización del adaptador](sec_api/adapter_initialization_sec_api.md)
