# Configuración gráfica: Marketaux
...
Use la vista avanzada para las propiedades restantes descritas en la página de [Configuración del conector](configuration_marketaux.md). Mantenga los puntos de conexión predefinidos salvo que el proveedor le haya asignado otros valores.
