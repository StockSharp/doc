...
**lemon.markets** conecta StockSharp con la interfaz oficial **API de intermediación de lemon.markets**.

El conector permite consultar la cuenta y operar con órdenes.
