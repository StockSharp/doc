...
**Morningstar Direct Web Services** - un conector para obtener datos de mercado de un proveedor.
...
> [!CAUTION]
> El conector proporciona datos de mercado y no permite enviar órdenes.
