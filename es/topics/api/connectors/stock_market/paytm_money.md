...
El **conector de Paytm Money** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Paytm Money, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](paytm_money/configuration_paytm_money.md)

[Configuración gráfica](paytm_money/graphical_configuration_paytm_money.md)

[Inicialización del adaptador](paytm_money/adapter_initialization_paytm_money.md)
