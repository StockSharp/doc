...
El **conector de Rupeezy** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Rupeezy, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](rupeezy/configuration_rupeezy.md)

[Configuración gráfica](rupeezy/graphical_configuration_rupeezy.md)

[Inicialización del adaptador](rupeezy/adapter_initialization_rupeezy.md)
