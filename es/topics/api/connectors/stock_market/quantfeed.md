...
**QuantFEED** - proveedor de datos de mercado en tiempo real para cotizaciones de acciones, Forex, noticias, contratos de futuros, etc.
...
[Inicialización del adaptador QuantFEED](quantfeed/adapter_initialization_quantfeed.md)
