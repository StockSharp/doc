...
**IG Markets** integra **API REST y de transmisión de IG** con StockSharp para obtener datos de mercado y operar.
...
Antes de desarrollar robots de negociación para IG Markets, consulte los enlaces de la sección [Conectores](../../connectors.md).
