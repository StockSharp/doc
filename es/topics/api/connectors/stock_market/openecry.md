...
**OpenECry (GAIN Futures)** — plataforma de trading para operar en exchanges internacionales.
...
[Inicialización del adaptador OpenECry](openecry/adapter_initialization_openecry.md)

[Conexión de varios algoritmos](openecry/several_algorithms_connection.md)

[Operación simultánea del terminal y el algoritmo](openecry/simultaneous_terminal_and_algorithm_operation.md)
