...
El **conector de Ventura** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Ventura, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](ventura/configuration_ventura.md)

[Configuración gráfica](ventura/graphical_configuration_ventura.md)

[Inicialización del adaptador](ventura/adapter_initialization_ventura.md)
