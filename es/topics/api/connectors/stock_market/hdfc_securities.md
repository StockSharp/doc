...
El **conector de HDFC Securities** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de HDFC Securities, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](hdfc_securities/configuration_hdfc_securities.md)

[Configuración gráfica](hdfc_securities/graphical_configuration_hdfc_securities.md)

[Inicialización del adaptador](hdfc_securities/adapter_initialization_hdfc_securities.md)
