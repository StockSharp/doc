...
El **conector de Wisdom Capital** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Wisdom Capital, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](wisdom_capital/configuration_wisdom_capital.md)

[Configuración gráfica](wisdom_capital/graphical_configuration_wisdom_capital.md)

[Inicialización del adaptador](wisdom_capital/adapter_initialization_wisdom_capital.md)
