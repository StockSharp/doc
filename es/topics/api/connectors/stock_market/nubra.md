...
El **conector de Nubra** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Nubra, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](nubra/configuration_nubra.md)

[Configuración gráfica](nubra/graphical_configuration_nubra.md)

[Inicialización del adaptador](nubra/adapter_initialization_nubra.md)
