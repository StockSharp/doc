...
**Tiger Brokers** integra **Tiger Brokers OpenAPI** con StockSharp para obtener datos de mercado y operar.
...
Antes de desarrollar robots de negociación para Tiger Brokers, consulte los enlaces de la sección [Conectores](../../connectors.md).
