# Configuración gráfica Blackwood (Fusion)
...
![Configuración de API GUI Fusion (Blackwood)](../../../../../images/api_gui_settings_fusion.png)

- **usuario** - Usuario.
- **contraseña** - Contraseña.
- **Datos de mercado** - Dirección del servidor de datos de mercado.
- **Historial** - Dirección del servidor de datos históricos.
- **Transacciones** - Dirección del servidor de ejecución de transacciones.
- **Ruta a registros** - Ruta al directorio donde se creará el archivo BWOrders.Log.
- **Sobrescribir** - Sobrescribir el archivo dll desde los recursos. Activado por defecto.
