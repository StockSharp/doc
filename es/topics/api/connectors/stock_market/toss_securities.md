...
El **conector de Toss Securities** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Toss Securities, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](toss_securities/configuration_toss_securities.md)

[Configuración gráfica](toss_securities/graphical_configuration_toss_securities.md)

[Inicialización del adaptador](toss_securities/adapter_initialization_toss_securities.md)
