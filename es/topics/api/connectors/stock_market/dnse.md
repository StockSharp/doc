...
El **conector de DNSE** conecta StockSharp con un bróker o mercado electrónico de instrumentos financieros. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de DNSE, del plan de API y de la cuenta conectada.

## Véase también

[Configuración del conector](dnse/configuration_dnse.md)

[Configuración gráfica](dnse/graphical_configuration_dnse.md)

[Inicialización del adaptador](dnse/adapter_initialization_dnse.md)
