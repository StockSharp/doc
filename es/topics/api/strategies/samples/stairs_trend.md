...
`StairsTrendStrategy` es una estrategia de trading basada en el análisis de velas consecutivas para determinar una tendencia. La estrategia abre posiciones cuando se forma una tendencia sostenida de una longitud específica.
