...
- **Tipo de vela** - tipo de vela con el que trabajar (predeterminado 1 minuto)
- **Longitud** - número de velas consecutivas en una dirección para identificar una tendencia (predeterminado 5)
