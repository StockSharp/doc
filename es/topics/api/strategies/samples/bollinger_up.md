# Estrategia Bollinger con foco en la banda superior

## Descripción general

`BollingerStrategyUpBandStrategy` es una estrategia basada en el indicador [BollingerBands](xref:StockSharp.Algo.Indicators.BollingerBands). Abre una posición larga cuando el precio alcanza el límite superior de las bandas de Bollinger y la cierra cuando el precio alcanza la línea media.
...
- **BollingerLength** - periodo del indicador Bollinger Bands (predeterminado 20)
...
En el método [OnStarted2](xref:StockSharp.Algo.Strategies.Strategy.OnStarted2(System.DateTime)), se crea el indicador Bollinger Bands, se configura la suscripción a velas y se prepara la visualización:
...
private void ProcessCandle(ICandleMessage candle, IIndicatorValue bollingerValue)
{
	...
	// Vender para cerrar la posición cuando el precio alcanza la línea media (solo con una posición larga)
...
- La estrategia usa solo la banda superior y la línea media del indicador Bollinger Bands
