...
1. [FileLogListener](xref:Ecng.Logging.FileLogListener) - escribe mensajes en un archivo de texto. Se recomienda usarlo para algoritmos ya creados y usar los logs en casos de fuerza mayor. 
...
[Logging de estrategias](logging/strategy_logging.md)

[Logging de IConnector](logging/iconnector_logging.md)

[Otras fuentes de logs](logging/other_logs_sources.md)
