...
![Hydra importación de velas](../../../images/hydra_import_candles.png)
...
2. Configure los parámetros de importación para los campos de [S#](../../api.md).
   ...
   - **Orden de campos** - secuencia en la que se organizan las columnas de propiedades del elemento importado.
     ...
     Entonces le corresponderá la siguiente configuración:![Hydra propiedades de importación de velas](../../../images/hydra_import_prop_candles.png)
...
3. Para previsualizar los datos, haga clic en el botón **Vista previa**.![Hydra vista previa de importación de velas](../../../images/hydra_import_preview_candles.png)
