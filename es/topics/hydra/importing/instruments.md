...
![Captura de Instrumentos 1](../../../images/hydra_import_securities.png)
...
2. Configure los parámetros de importación para los campos de [S#](../../api.md).
   ...
   **Veamos un ejemplo de importación de un instrumento desde un archivo CSV:**
   ...
   - La ventana de configuración de campos tendrá este aspecto:![Captura de Instrumentos 2](../../../images/hydra_import_prop_securitiy.png)
...
3. Para previsualizar los datos, haga clic en el botón **Vista previa**.![Captura de Instrumentos 3](../../../images/hydra_import_preview_securitiy.png)
