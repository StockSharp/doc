...
3. En la fuente, especifique a partir de qué se construirán las velas: **Ticks**.![hydra type candle 00 07](../../../images/hydra_type_candle_00_07.png)
4. Establezca el período.
5. Haga clic en Start y los datos empezarán a descargarse.![hydra type candle 00 08](../../../images/hydra_type_candle_00_08.png)
6. Vaya a la sección de velas y [vea los datos descargados](../working_with_data/view_and_export.md).![hydra type candle 00 09](../../../images/hydra_type_candle_00_09.png)
