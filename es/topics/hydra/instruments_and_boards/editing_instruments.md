...
Para editar un instrumento (por ejemplo, si se creó sin todos los datos necesarios), haga doble clic en el instrumento o haga clic en el botón ![Hydra edición](../../../images/hydra_edit.png) para abrir la ventana donde puede realizar los cambios necesarios:
...
Si es necesario, puede editar el grupo de instrumentos. Seleccione un grupo de instrumentos y haga clic en el botón ![Hydra edición](../../../images/hydra_edit.png).
