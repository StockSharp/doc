...
La esquina superior izquierda de cada gráfico muestra todos los elementos gráficos añadidos al gráfico. Si desmarca la casilla del elemento gráfico ![Designer elemento gráfico 00](../../../../images/designer_schedule_00.png), el elemento se eliminará del gráfico. Al hacer clic en el botón ![Designer elemento gráfico 01](../../../../images/designer_schedule_01.png), se abrirá la configuración del elemento gráfico. También puede configurar el elemento gráfico en las propiedades del cubo [Gráfico](../../strategies/using_visual_designer/elements/common/chart.md).
