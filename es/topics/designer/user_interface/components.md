...
- [Estadísticas](components/statistics.md) - representa una tabla agrupada por categorías: P/L, operaciones, posiciones, órdenes. Contiene datos sobre el rendimiento de la estrategia.
...
- Propiedades - representa una tabla de [Configuración de pruebas históricas](components/backtesting_settings.md) o una tabla de [Configuración en vivo](components/live_settings.md).
- [Esquema](../strategies/using_visual_designer/diagram_panel.md) - representa el diseñador de esquemas.
- [Código fuente](../strategies/using_code.md) - representa una ventana para crear o editar estrategias basadas en código fuente.
...
- [Gráfico de posiciones de opciones](../strategies/using_visual_designer/elements/options/chart_positions.md) - representa un gráfico de posición de opciones.
- [Mesa de opciones](../strategies/using_visual_designer/elements/options/option_desk.md) - representa una tabla de opciones.
- [Profundidad de mercado](components/order_book.md) - representa una tabla de órdenes limitadas de compra y venta.
- [Registro de órdenes](../../terminal/user_interface/components/order_log.md) - representa una tabla con órdenes, mostrando información completa sobre todas las órdenes de los instrumentos seleccionados.
