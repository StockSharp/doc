...
1. La carpeta **Prueba histórica** contiene estrategias de trading creadas tanto como esquemas de un conjunto de elementos y conexiones entre ellos, como desde código. Puede añadir una nueva estrategia pulsando el botón **Añadir** ![Designer Panel Circuits 01](../../../images/designer_panel_circuits_01_button.png) en la pestaña **Común** y seleccionando **Estrategia**. O haciendo clic con el botón derecho en la carpeta **Prueba histórica** del panel **Esquemas** y pulsando el botón **Añadir** ![Designer Panel Circuits 01](../../../images/designer_panel_circuits_01_button.png) en el menú desplegable. En la ventana que se abre, seleccione exactamente cómo desea crear una estrategia.
