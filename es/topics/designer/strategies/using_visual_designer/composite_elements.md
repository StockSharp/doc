...
Para los cubos CurrComparison y PrevComparison, se establece la bandera **Parámetros** del grupo de propiedades **Común**. Por lo tanto, las propiedades de estos cubos se incorporan a las propiedades del elemento compuesto [Cruce](elements/common/crossing.md), que se especificarán posteriormente al usar un elemento compuesto en el esquema de la estrategia.
