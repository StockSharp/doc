...
El diagrama del elemento compuesto consta de elementos simples y se basa en memorizar los valores actuales (Prev In 1 y Prev In 2) y comparar entre sí los pares de valores actuales (CurrComparison) y anteriores (PrevComparison). Como cada uno de los valores de entrada se usa en dos elementos del diagrama, los elementos [Combination](elements/common/combination.md) (In 1, In 2) se colocan en la entrada del elemento compuesto; permiten dividir una entrada en dos elementos y pasar el valor de entrada a los elementos [Comparison](elements/common/comparison.md) y [Prev value](elements/common/prev_value.md). Cuando llega un nuevo valor a la entrada, se comparan los valores actuales y se pasa un nuevo valor al elemento [Prev value](elements/common/prev_value.md), desde el cual se pasa el valor anterior para la entrada actual; luego se comparan los valores anteriores. Si se cumplen ambas condiciones, lo que se comprueba mediante la condición And [Logical condition](elements/common/logical_condition.md), entonces el valor de la bandera activada se pasa a la salida del elemento compuesto, que puede usarse como disparador para una acción posterior.

Para los cubos CurrComparison y PrevComparison, se establece la bandera **Parameters** del grupo de propiedades **Common**. Por lo tanto, las propiedades de estos cubos se tomaron en las propiedades del elemento compuesto [Crossing](elements/common/crossing.md), que se especificarán posteriormente al usar un elemento compuesto en el esquema de la estrategia.
