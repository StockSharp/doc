...
Para los cubos CurrComparison y PrevComparison, se establece la bandera **Parameters** del grupo de propiedades **Common**. Por lo tanto, las propiedades de estos cubos se tomaron en las propiedades del elemento compuesto [Cruce](elements/common/crossing.md), que se especificarán posteriormente al usar un elemento compuesto en el esquema de la estrategia.
