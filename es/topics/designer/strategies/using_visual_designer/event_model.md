...
Por ejemplo, el cubo [Order book](elements/market_depths/order_book.md) genera un evento de cambio del libro de órdenes. No se sabe de antemano cuándo ocurrirá un cambio. Al crear una línea de conexión entre el cubo [Order book](elements/market_depths/order_book.md) y el cubo [Converter](elements/converters/converter.md), se realiza una suscripción al cambio del libro de órdenes para su posterior procesamiento con el cubo [Converter](elements/converters/converter.md), etc.:
