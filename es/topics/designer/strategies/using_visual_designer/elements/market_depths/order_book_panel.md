...
- **Order Book** - libro de órdenes que debe mostrarse.
- **Order** - orden cuyo volumen debe mostrarse en la columna *Own Volume*.
- **Order Error** - error de registro o cancelación de una orden, para el que debe mostrarse animación.

## Véase también

[Libro de órdenes agrupado](grouped_order_book.md)
