...
- **Entrada**: cuando se conecta una nueva fuente de datos, se crean automáticamente un conector de salida correspondiente y un nuevo conector de entrada. El número de valores entrantes es ilimitado.
...
- **Borrar elementos**: si esta opción está activada, los datos se limpian después de acumularse para todos los conectores de entrada conectados, o se acumulan hasta que aparezcan datos del siguiente intervalo temporal.
