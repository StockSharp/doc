...
- **Volumen** (opcional): volumen para operaciones "Increase" y "Decrease". No se usa para "Reverse" y "Close Position".
...
- **Saldo**: este socket transmite información sobre la parte de la posición que no se realizó al final de la operación de modificación de posición. El valor devuelto por el socket indica el resultado de la operación:
