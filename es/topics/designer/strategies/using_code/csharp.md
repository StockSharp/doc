...
La pestaña del editor de código consta de los paneles **Source Code** y **Error List**. El panel **Source Code** contiene el propio editor de código C#. En la parte superior hay una barra de herramientas donde puede activar o desactivar el resaltado de elementos como **Current Line**, **Line Number**, etc. Para aumentar el tamaño de fuente, puede usar la combinación CTRL+MouseWheel.
