...
Una estrategia creada desde código puede dibujar datos en el panel [Order Book](../../../user_interface/components/order_book.md) de forma similar al cubo [Order Book](../../using_visual_designer/elements/market_depths/order_book_panel.md). Para ello, debe escribirse el siguiente código.
...
4. Añada el panel [Order Book](../../../user_interface/components/order_book.md) y seleccione la fuente creada en el código:
