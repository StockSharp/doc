...
3. La ejecución de la estrategia en [prueba histórica](../backtesting/user_interface.md), en [modo en vivo](../live_execution/getting_started.md) y otras operaciones funcionan de forma similar a una estrategia creada desde diagramas y código:
