...
El almacenamiento de datos históricos está diseñado para cargar datos de mercado (instrumentos, velas, operaciones tick y libros de órdenes) desde distintas fuentes y guardarlos en un almacenamiento local o remoto. [Designer](../designer.md) puede usar fuentes tanto de datos históricos como de datos en tiempo real ([Connectors](../api/connectors.md)). Después, la información almacenada queda disponible para su uso por estrategias de trading.
