...
![Designer Interfaz de pruebas históricas 00](../../../images/designer_interface_backtesting_00.png)

En la pestaña **Emulación**, puede cambiar el nombre de la estrategia y darle una breve descripción.

Para ejecutar la prueba sobre historial, en la **pestaña Emulación** especifique la ruta a los datos históricos en el campo **Datos de mercado** y establezca el período de prueba. La estrategia para pruebas se inicia haciendo clic en el **botón Iniciar** ![Designer Interfaz de pruebas históricas 01](../../../images/designer_interface_backtesting_01.png). Después de iniciar la estrategia para pruebas, se activan el botón **Pausa** ![Designer Interfaz de pruebas históricas 02](../../../images/designer_interface_backtesting_02.png), que suspende la prueba, y el botón **Detener** ![Designer Interfaz de pruebas históricas 03](../../../images/designer_interface_backtesting_03.png), que detiene completamente la prueba. Al editar la estrategia, son útiles los botones **Deshacer (Ctrl+Z)** ![Designer Interfaz de pruebas históricas 04](../../../images/designer_interface_backtesting_04.png), que cancela la última acción, **Rehacer (Ctrl+Y)** ![Designer Interfaz de pruebas históricas 05](../../../images/designer_interface_backtesting_05.png), que rehace la acción deshecha, y **Actualizar (Ctrl+R)** ![Designer Interfaz de pruebas históricas 06](../../../images/designer_interface_backtesting_06.png), que actualiza completamente el esquema. Además, desde la **pestaña Emulación** puede usar el **Depurador** ([Depuración](debugging.md)) o ejecutar la **Optimización** de la estrategia.
