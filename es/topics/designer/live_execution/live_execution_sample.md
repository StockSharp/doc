...
![Designer Ejemplo de negociación en vivo 00](../../../images/designer_example_of_live_trading_00.png)
...
![Designer Ejemplo de negociación en vivo 01](../../../images/designer_example_of_live_trading_01.png)

Después de configurar todos los parámetros requeridos, inicie la negociación en vivo para la estrategia haciendo clic en el botón **Iniciar** ![Designer Panel de circuitos 02](../../../images/designer_panel_circuits_02.png).
...
![Designer Ejemplo de negociación en vivo 02](../../../images/designer_example_of_live_trading_02.png)
...
A continuación se muestran gráficos de [Designer](../../designer.md) y del terminal de negociación para el mismo período.

![Designer Ejemplo de negociación en vivo 03](../../../images/designer_example_of_live_trading_03.png)

Gráfico de [Designer](../../designer.md):

![Designer Ejemplo de negociación en vivo 04](../../../images/designer_example_of_live_trading_04.png)

Gráfico del terminal de negociación:
