...
- **Compositions** almacena, como archivos XML, todos los bloques de la carpeta **Elementos compuestos** del [Panel Esquemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina el **Elemento compuesto** correspondiente de la carpeta **Elementos compuestos** del [Panel Esquemas](../user_interface/schemas.md). No edite estos archivos manualmente; hacerlo puede romper el bloque **Elementos compuestos** correspondiente.
- **LiveStrategies** almacena, como archivos XML, todos los bloques de la carpeta **Operaciones** del [Panel Esquemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina la estrategia de la carpeta **Operaciones** del [Panel Esquemas](../user_interface/schemas.md). No edite estos archivos manualmente; hacerlo puede romper la estrategia correspondiente.
...
- **SourceCode** almacena, como archivos XML, todos los bloques de la carpeta **Código fuente** del [Panel Esquemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina el bloque **Código fuente** de la carpeta **Código fuente** del [Panel Esquemas](../user_interface/schemas.md). No edite estos archivos manualmente; hacerlo puede romper el bloque **Código fuente** correspondiente.
- **Estrategias** almacena, como archivos XML, todos los bloques de la carpeta **Estrategias** del [Panel Esquemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina la estrategia de la carpeta **Estrategias** del Panel Esquemas. No edite estos archivos manualmente; hacerlo puede romper la estrategia correspondiente. Si añade manualmente un archivo de estrategia a esta carpeta y reinicia [Designer](../../designer.md), la estrategia aparecerá en la carpeta **Estrategias** del [Panel Esquemas](../user_interface/schemas.md).
...
- **exchange.csv** y **exchangeboard.csv** contienen la lista de **bolsas**, códigos de instrumentos y modos de negociación. Estos archivos pueden editarse en un editor de texto estándar o MS Excel.
