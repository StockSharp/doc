...
- **Compositions** almacena, como archivos XML, todos los bloques de la carpeta **Composite elements** del panel [Schemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina el **Composite element** correspondiente de la carpeta **Composite elements** del panel [Schemas](../user_interface/schemas.md). No edite estos archivos manualmente; hacerlo puede romper el bloque **Composite elements** correspondiente.
- **LiveStrategies** almacena, como archivos XML, todos los bloques de la carpeta **Trading** del panel [Schemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina la estrategia de la carpeta **Trading** del panel [Schemas](../user_interface/schemas.md). No edite estos archivos manualmente; hacerlo puede romper la estrategia correspondiente.
- **Logs** contiene todos los registros de fallos de [Designer](../../designer.md), lo que simplifica la solución de problemas de [Designer](../../designer.md).
- **SourceCode** almacena, como archivos XML, todos los bloques de la carpeta **Source code** del panel [Schemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina el bloque **Source code** de la carpeta **Source code** del panel [Schemas](../user_interface/schemas.md). No edite estos archivos manualmente; hacerlo puede romper el bloque **Source code** correspondiente.
- **Strategies** almacena, como archivos XML, todos los bloques de la carpeta **Strategies** del panel [Schemas](../user_interface/schemas.md). Eliminar archivos de este directorio elimina la estrategia de la carpeta **Strategies** del panel Schemas. No edite estos archivos manualmente; hacerlo puede romper la estrategia correspondiente. Si añade manualmente un archivo de estrategia a esta carpeta y reinicia [Designer](../../designer.md), la estrategia aparecerá en la carpeta **Strategies** del panel [Schemas](../user_interface/schemas.md).
- **Storage** contiene datos de mercado descargados por [Designer](../../designer.md) en el [Almacenamiento de datos de mercado](../market_data_storage.md) correspondiente. La carpeta se crea al crear el [Almacenamiento de datos de mercado](../market_data_storage.md), y la ruta predeterminada apunta a esta carpeta. Eliminar esta carpeta elimina todos los datos de mercado descargados del almacenamiento correspondiente. Si el almacenamiento contiene archivos CSV, pueden editarse en un editor de texto estándar o MS Excel. Los archivos BIN no pueden editarse manualmente.
- **exchange.csv** y **exchangeboard.csv** contienen la lista de **exchanges**, códigos de instrumentos y modos de trading. Estos archivos pueden editarse en un editor de texto estándar o MS Excel.
