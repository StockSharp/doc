...
Después, en [Designer](../../designer.md), cree un nuevo almacenamiento haciendo clic en el botón ![Designer Creating a repository of historical data 00](../../../images/designer_creating_repository_of_historical_data_00.png). En la configuración del almacenamiento, en el campo de dirección, especifique "net.tcp:\/\/localhost:8000". Haga clic en OK. Al usar [Hydra](../../hydra.md) como almacenamiento remoto, no olvide que [Hydra](../../hydra.md) debe iniciarse y configurarse correspondientemente.
