...
Die eigenständige Browser-Diagramm-Engine und der Diagramm-Stack für Webterminals werden in [StockSharp\/JS-Charts](https://github.com/StockSharp/JS-Charts) gepflegt. Siehe [JavaScript-Diagramme](../api/javascript_ui/charts.md).
