...
![RemoteManager Bildschirmfoto 1](../../../images/shell_remotemanager_00.png)

Legen Sie im angezeigten Fenster Ihren **Benutzernamen** und Ihr **Passwort** fest.

![RemoteManager Bildschirmfoto 2](../../../images/shell_remotemanager_01.png)

Danach müssen Sie den **Servermodus** aktivieren.

![RemoteManager Bildschirmfoto 3](../../../images/shell_remotemanager_02.png)
...
![RemoteManager Bildschirmfoto 4](../../../images/shell_remotemanager_03.png)

Richten Sie im geöffneten Fenster die FIX-Verbindung ein.

![RemoteManager Bildschirmfoto 5](../../../images/shell_remotemanager_04.png)

Drücken Sie anschließend die Schaltfläche Verbinden.

![RemoteManager Bildschirmfoto 6](../../../images/shell_remotemanager_05.png)

Nach der Verbindung sind alle vorhandenen Strategien auf dem Shell-Server im Shell-Client verfügbar.

![RemoteManager Bildschirmfoto 7](../../../images/shell_remotemanager_06.png)

Durch Klicken auf die Schaltfläche Hinzufügen können Sie eine weitere Strategie für den Handel hinzufügen.

![RemoteManager Bildschirmfoto 8](../../../images/shell_remotemanager_07.png)
...
![RemoteManager Bildschirmfoto 9](../../../images/shell_remotemanager_08.png)

Nach dem Hinzufügen einer Strategie erscheint sie in der Strategieliste.

![RemoteManager Bildschirmfoto 10](../../../images/shell_remotemanager_09.png)
...
![RemoteManager Bildschirmfoto 11](../../../images/shell_remotemanager_10.png)

Wenn die Strategie einen anderen Befehl als Start\/Stop besitzt, müssen Sie ihn zum Anwenden im nächsten Feld festlegen.

![RemoteManager Bildschirmfoto 12](../../../images/shell_remotemanager_11.png)
