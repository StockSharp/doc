...
- [Positions](components/positions.md) - stellt eine Tabelle mit Positionen für die Instrumente der Strategie dar.
- [Statistics](components/statistics.md) - stellt eine nach Kategorien gruppierte Tabelle dar: P/L, Trades, Positions, Orders. Sie enthält Daten zur Performance der Strategie.
...
- [Order log](../../terminal/user_interface/components/order_log.md) - stellt eine Tabelle mit Orders dar, die vollständige Informationen zu allen Orders für ausgewählte Instrumente anzeigt.
