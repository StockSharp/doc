...
- **security.csv** enthält alle empfangenen und erstellten Instrumente aus allen Quellen. Das Löschen dieser Datei entfernt alle Instrumente aus [Designer](../../designer.md). Das Hinzufügen neuer Instrumente wird unter [Download instruments](../market_data_storage/download_instruments.md) und [Create instrument](../market_data_storage/create_instrument.md) beschrieben. Diese Datei kann in einem Standard-Texteditor oder MS Excel bearbeitet werden.
