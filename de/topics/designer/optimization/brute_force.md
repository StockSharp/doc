...
Um in den Strategieoptimierungsmodus zu wechseln, klicken Sie im Tab **Emulation** auf die Schaltfläche **Optimization**. Das Optimierungsbeispiel wird anhand der SMA-Strategie betrachtet, die [aus Würfeln](../strategies/using_visual_designer/first_strategy.md) erstellt wurde.

![Designer Optimization 00](../../../images/designer_optimization_00.png)

Im Arbeitsbereich wird ein Tab mit dem Namen Optimization + 'Strategy Name' geöffnet. Der Tab **Optimization** ist in zwei Bereiche unterteilt: **Properties** und **Optimization Result**:
