...
- **Eingang**: Wenn eine neue Datenquelle verbunden wird, werden automatisch ein entsprechender ausgehender Anschluss und ein neuer eingehender Anschluss erstellt. Die Anzahl eingehender Werte ist unbegrenzt.
...
- **Elemente löschen**: Wenn diese Option aktiviert ist, werden Daten nach ihrer Sammlung für alle verbundenen eingehenden Anschlüssen gelöscht; andernfalls werden Daten gesammelt, bis Daten aus dem nächsten Zeitintervall erscheinen.
