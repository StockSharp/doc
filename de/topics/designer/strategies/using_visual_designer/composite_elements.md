...
Das Diagramm des zusammengesetzten Elements besteht aus einfachen Elementen und basiert darauf, die aktuellen Werte (Prev In 1 und Prev In 2) zu merken und die Paare aus aktuellen (CurrComparison) und vorherigen (PrevComparison) Werten miteinander zu vergleichen. Da jeder der Eingangswerte in zwei Elementen des Diagramms verwendet wird, werden die Elemente [Combination](elements/common/combination.md) (In 1, In 2) am Eingang des zusammengesetzten Elements platziert. Sie erlauben es, einen Eingang auf zwei Elemente aufzuteilen und den Eingangswert an die Elemente [Comparison](elements/common/comparison.md) und [Prev value](elements/common/prev_value.md) weiterzugeben. Wenn ein neuer Wert am Eingang eintrifft, werden die aktuellen Werte verglichen und ein neuer Wert an das Element [Prev value](elements/common/prev_value.md) übergeben, aus dem der vorherige Wert für den aktuellen Eingang weitergegeben wird. Danach werden die vorherigen Werte verglichen. Wenn beide Bedingungen erfüllt sind, was mit der And [Logical condition](elements/common/logical_condition.md) geprüft wird, wird der Wert des gesetzten Flags an den Ausgang des zusammengesetzten Elements übergeben und kann als Trigger für weitere Aktionen verwendet werden.

Für die Würfel CurrComparison und PrevComparison ist das Flag **Parameters** der Eigenschaftsgruppe **Common** gesetzt. Daher wurden die Eigenschaften dieser Würfel in die Eigenschaften des zusammengesetzten Elements [Crossing](elements/common/crossing.md) übernommen, die später bei der Verwendung des zusammengesetzten Elements im Strategieschema angegeben werden.
