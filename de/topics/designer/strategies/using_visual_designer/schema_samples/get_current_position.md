...
Für den Würfel [Variable](../elements/data_sources/variable.md) wird der Datentyp **Instrument** ausgewählt. Wenn das Instrument nicht angegeben ist, aber das Flag **Parameters** der Gruppe **Common** gesetzt ist, wird es aus der Strategie übernommen und anschließend an [Position](../elements/positions/current.md) übergeben.

Für den Würfel [Position](../elements/positions/current.md) ist die Positionseigenschaft ebenfalls nicht angegeben, aber das Flag **Parameters** der Gruppe **Common** ist gesetzt. Das bedeutet, dass die Position für das Portfolio ermittelt wird, das in den Strategieeinstellungen angegeben ist.
