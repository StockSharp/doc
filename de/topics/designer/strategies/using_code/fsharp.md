...
Der Prozess zum Erstellen einer Strategie findet direkt im [Designer](../../../designer.md) oder in einer **F#**-Entwicklungsumgebung statt (die beliebtesten sind **Visual Studio** und **JetBrains Rider**). Dabei wird eine Bibliothek für die professionelle Entwicklung von Handelsrobotern in **F#** und [API](../../../api.md) verwendet.
