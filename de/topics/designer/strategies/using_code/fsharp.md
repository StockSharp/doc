...
Das Erstellen von Strategien aus Code richtet sich an Benutzer, die bevorzugt mit F#-Code arbeiten. Solche Strategien sind im Gegensatz zu Diagrammen nicht in ihren Möglichkeiten eingeschränkt, und jeder Algorithmus kann beschrieben werden.

Der Prozess zum Erstellen einer Strategie findet direkt in [Designer](../../../designer.md) oder in einer **F#**-Entwicklungsumgebung statt (die beliebtesten sind **Visual Studio** und **JetBrains Rider**). Dabei wird eine Bibliothek für die professionelle Entwicklung von Handelsrobotern in **F#** und [API](../../../api.md) verwendet.
...
Der Code-Editor-Tab besteht aus den Panels **Source Code** und **Error List**. Das Panel **Source Code** enthält den eigentlichen F#-Code-Editor. Oben befindet sich eine Symbolleiste, in der Hervorhebungen wie **Current Line**, **Line Number** usw. ein- oder ausgeschaltet werden können. Um die Schriftgröße zu erhöhen, können Sie die Kombination CTRL+MouseWheel verwenden.
