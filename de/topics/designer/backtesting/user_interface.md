...
![Designer Backtesting-Oberfläche 00](../../../images/designer_interface_backtesting_00.png)

Im Tab **Simulation** können Sie den Strategienamen ändern und eine kurze Beschreibung angeben.

Um den Test auf historischen Daten auszuführen, geben Sie auf der Registerkarte **Simulation** im Feld **Marktdaten** den Pfad zu den historischen Daten an und legen den Testzeitraum fest. Das Testing der Strategie wird durch Klicken auf die Schaltfläche **Starten** ![Designer Backtesting-Oberfläche 01](../../../images/designer_interface_backtesting_01.png) gestartet. Nach dem Start der Strategie zum Testing werden die Schaltfläche **Pause** ![Designer Backtesting-Oberfläche 02](../../../images/designer_interface_backtesting_02.png), die das Testing anhält, und die Schaltfläche **Stopp** ![Designer Backtesting-Oberfläche 03](../../../images/designer_interface_backtesting_03.png), die das Testing vollständig beendet, aktiv. Beim Bearbeiten der Strategie sind die Schaltflächen **Rückgängig (Ctrl+Z)** ![Designer Backtesting-Oberfläche 04](../../../images/designer_interface_backtesting_04.png), zum Rückgängigmachen der letzten Aktion, **Wiederholen (Ctrl+Y)** ![Designer Backtesting-Oberfläche 05](../../../images/designer_interface_backtesting_05.png), zum Wiederherstellen rückgängig gemachter Aktionen, und **Aktualisieren (Ctrl+R)** ![Designer Backtesting-Oberfläche 06](../../../images/designer_interface_backtesting_06.png), zum vollständigen Aktualisieren des Schemas, hilfreich. Außerdem können Sie auf der Registerkarte **Simulation** den **Debugger** ([Debugging](debugging.md)) verwenden oder die **Optimierung** der Strategie ausführen.
