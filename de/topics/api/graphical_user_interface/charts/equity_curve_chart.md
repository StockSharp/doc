# Equity-Curve-Diagramm

[EquityCurveChart](xref:StockSharp.Xaml.Charting.EquityCurveChart) ist eine grafische Komponente zur Anzeige der Equity-Kurve.
...
1. Wir fügen die grafische Komponente [EquityCurveChart](xref:StockSharp.Xaml.Charting.EquityCurveChart) in XAML hinzu und weisen der Komponente den Namen **Curve** zu.
