...
# Liqui-Adapter initialisieren

Der folgende Code zeigt, wie der [LiquiMessageAdapter](xref:StockSharp.Liqui.LiquiMessageAdapter) initialisiert und an den [Connector](xref:StockSharp.Algo.Connector) übergeben wird.
