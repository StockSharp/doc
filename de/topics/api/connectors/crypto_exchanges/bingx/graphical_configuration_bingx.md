# Grafische Konfiguration von BingX
...
- **Secret** - Secret.
- **Demo** - Demo-Modus.
- **Reconnection settings** - Parameter des Wiederverbindungsmechanismus mit dem Handelssystem ([Wiederverbindungseinstellungen](../../reconnection_settings.md)).
