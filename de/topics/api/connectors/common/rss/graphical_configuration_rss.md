...
![API-GUI-Einstellungen RSS](../../../../../images/api_gui_settings_rss.png)

- **Adresse** - Adresse des RSS-Feeds.
- **Datumsformat** - Datumsformat. Erforderlich, wenn das Format des RSS-Streams von `ddd, dd MMM yyyy HH:mm:ss zzzz` abweicht.
