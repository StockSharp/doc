...
1. Wenn Sie auf die Schaltfläche "Prüfen" klicken, öffnet sich ein Fenster:

   ![Grafische Konfiguration von cTrader Bildschirmfoto](../../../../../images/oauth_start.png)

2. Nach einem Klick auf "Starten" wird der Benutzer zur cTrader-Website weitergeleitet, um sich anzumelden. Auf der cTrader-Website müssen Sie der StockSharp-Anwendung Zugriff auf Handelsoperationen erlauben:
