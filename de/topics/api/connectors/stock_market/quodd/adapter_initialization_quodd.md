# Adapterinitialisierung QUODD

Der folgende Code zeigt, wie der [QuoddMessageAdapter](xref:StockSharp.Quodd.QuoddMessageAdapter) initialisiert und an den [Connector](xref:StockSharp.Algo.Connector) übergeben wird.
