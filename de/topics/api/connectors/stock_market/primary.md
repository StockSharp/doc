...
Der **Primary-Konnektor** verbindet StockSharp mit einem Broker oder elektronischen Handelsplatz für Finanzmärkte. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Primary, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.

## Siehe auch

[Connector-Konfiguration](primary/configuration_primary.md)

[Grafische Konfiguration](primary/graphical_configuration_primary.md)

[Adapterinitialisierung](primary/adapter_initialization_primary.md)
