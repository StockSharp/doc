# Grafische Konfiguration von Robinhood
...
- **Token** - Eigenschaft `Token`.
- **Adresse** - Eigenschaft `Address`. Standardwert: `https://agent.robinhood.com/mcp/trading`.
- **Abfrageintervall** - Eigenschaft `PollingInterval`. Standardwert: `2 s`.
