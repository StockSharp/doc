...
- **Schlüssel** — der Anwendungsschlüssel der Webull OpenAPI.
- **Geheimnis** — das Anwendungsgeheimnis.
- **Zugriffstoken** — ein optionales Zugriffstoken.
- **Konto** — die Kennung des Handelskontos. Ist kein Wert angegeben, ruft der Konnektor die Kontoliste automatisch ab.
- **Demomodus** — Verwendung der Webull-Testumgebung.
