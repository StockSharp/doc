...
Der **InvertirOnline-Konnektor** verbindet StockSharp mit einem Broker oder elektronischen Handelsplatz für Finanzmärkte. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Aktien, Futures, Optionen, Forex und Rohstoffe.
- Instrumentensuche und Referenzdaten des Anbieters.
- Vom Adapter unterstützte Marktdaten: Level-1-Kurse, Orderbücher und Kerzen.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von InvertirOnline, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.

## Siehe auch

[Connector-Konfiguration](invertironline/configuration_invertironline.md)

[Grafische Konfiguration](invertironline/graphical_configuration_invertironline.md)

[Adapterinitialisierung](invertironline/adapter_initialization_invertironline.md)
