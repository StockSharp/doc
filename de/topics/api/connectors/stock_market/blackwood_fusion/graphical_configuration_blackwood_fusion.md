...
- **Login** - Login.
- **Password** - Password.
- **Market data** - Adresse des Marktdatenservers.
- **History** - Adresse des Servers fuer historische Daten.
- **Transactions** - Serveradresse fuer die Ausfuehrung von Transaktionen.
- **Path to logs** - Pfad zum Verzeichnis, in dem die Datei BWOrders.Log erstellt wird.
- **Override** - DLL-Datei aus Ressourcen ueberschreiben. Standardmaessig aktiviert.
