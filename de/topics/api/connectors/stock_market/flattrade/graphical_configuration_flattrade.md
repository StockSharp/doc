# Grafische Konfiguration: Flattrade
...
- `UserId` - Konto- oder Clientkennung.
- `AccountId` - Konto- oder Clientkennung.
- `Token` - Zugangsdaten für die Authentifizierung.
- `DefaultProduct` - Betriebsart oder Option des Konnektors. Standardwert: `FlattradeProducts.Delivery`.
