...
2. **CQG Continuum**, direkte Verbindung zum Server. Geben Sie **Benutzername**, **Passwort** und die **Serveradresse** an.

**Benutzername**, **Passwort** und **Serveradresse** werden vom Broker bereitgestellt. Für den API-Zugriff wird empfohlen, den Broker zu kontaktieren.
