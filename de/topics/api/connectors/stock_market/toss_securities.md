...
Der **Toss Securities-Konnektor** verbindet StockSharp mit einem Broker oder elektronischen Handelsplatz für Finanzmärkte. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Toss Securities, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.

## Siehe auch

[Connector-Konfiguration](toss_securities/configuration_toss_securities.md)

[Grafische Konfiguration](toss_securities/graphical_configuration_toss_securities.md)

[Adapterinitialisierung](toss_securities/adapter_initialization_toss_securities.md)
