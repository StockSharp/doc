...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Nuvama, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.

## Siehe auch

[Connector-Konfiguration](nuvama/configuration_nuvama.md)

[Grafische Konfiguration](nuvama/graphical_configuration_nuvama.md)

[Adapterinitialisierung](nuvama/adapter_initialization_nuvama.md)
