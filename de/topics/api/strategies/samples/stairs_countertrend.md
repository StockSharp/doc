# Stairs-Gegentrendstrategie

## Überblick

`StairsCountertrendStrategy` ist eine Gegentrend-Handelsstrategie, die Positionen gegen einen etablierten Trend einer bestimmten Länge eröffnet.
...
private void ProcessCandle(ICandleMessage candle)
{
	...
	// Gegentrendstrategie:
	// Nach Length aufeinanderfolgenden bullischen Kerzen verkaufen
	if (_bullLength >= Length && Position >= 0)
	{
		SellMarket(Volume + Math.Abs(Position));
	}
	// Nach Length aufeinanderfolgenden bärischen Kerzen kaufen
