...
**Adaptiver Laguerre-Filter (ALF)** ist ein Indikator, der entwickelt wurde, um Preisdaten mit minimaler Verzögerung zu glätten. Er basiert auf den mathematischen Prinzipien des Laguerre-Filters.
