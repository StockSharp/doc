...
Unten ist ein Beispiel für die Implementierung des prozentualen Volumenoszillators (PVO), das die Implementierung von `NumValuesToInitialize`, `Measure` sowie der Methoden `Save` und `Load` demonstriert:
