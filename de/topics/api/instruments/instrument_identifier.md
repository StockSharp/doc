...
Instrumentenbezeichner verwenden die folgende Syntax: **\[Instrumentencode\]@\[Handelsplatzcode\]**. Für Aktien von Apple Inc. lautet der Bezeichner **AAPL@NASDAQ**. Bei Derivaten ist der Handelsplatzcode der Handelsplatz, an dem der Kontrakt gehandelt wird. Der Juni-Futures-Kontrakt auf den ES-Index kann beispielsweise als **ESM5@NYSE** identifiziert werden.
