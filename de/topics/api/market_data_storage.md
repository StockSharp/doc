...
3. Sammeln von Daten für Analyse und Data Mining.

[S#](../api.md) macht den Speichermechanismus durch High-Level-Zugriff und das Verbergen technischer Details verständlich (weitere Details siehe [API](market_data_storage/api.md)). Außerdem ist er vielseitig und bietet die Möglichkeit, die Typen unterstützter Speicher zu erweitern.
