...
- Die zweite Candle hat einen kleinen Körper (sie kann bullisch oder bärisch sein) und bildet gegenüber der ersten Candle ein Abwärts-Gap. Der Körper ist deutlich kleiner als der Körper der ersten Candle (B < pB * 0.5m).
- Die dritte Candle ist weiß (bullisch), mit Eröffnungskurs unterhalb des Schlusskurses (O < C), und schließt tief innerhalb des Körpers der ersten Candle.
- Entsteht in einem Abwärtstrend.

![Morning-Star-Muster](../../../images/morningstarpattern.png)
...
- Das Gewinnziel kann auf Basis von Fibonacci-Niveaus relativ zur vorherigen Abwärtsbewegung oder auf Basis vorheriger Widerstandsniveaus gesetzt werden.
- Achten Sie auf das Volumen - steigendes Volumen bei der dritten Candle bestätigt die Stärke der bullischen Umkehr.
- Kombinieren Sie das Muster mit anderen technischen Indikatoren, etwa RSI in der überverkauften Zone oder Unterstützungslinien, um die Zuverlässigkeit des Signals zu erhöhen.
