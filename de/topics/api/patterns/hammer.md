...
- Kleiner Candle-Körper im oberen Bereich der Preisspanne.
- Langer unterer Schatten, typischerweise 2- bis 3-mal länger als der Körper.
- Kein oberer Schatten oder nur ein sehr kurzer.
- Entsteht in einem Abwärtstrend.

![Hammer-Muster](../../../images/hammerpattern.png)
...
Hammer bietet Möglichkeiten für den Einstieg in eine Long-Position:

- Warten Sie auf Bestätigung durch die nächste Candle - eine bullische Candle nach einem Hammer verstärkt das Umkehrsignal.
- Platzieren Sie einen Stop-Loss unterhalb des Tiefs des Hammer.
- Legen Sie ein Gewinnziel auf Basis vorheriger Widerstandsniveaus oder des Risiko-Ertrags-Verhältnisses fest.
- Kombinieren Sie das Muster mit anderen technischen Indikatoren wie RSI oder MACD, um die Trendumkehr zu bestätigen.
- Höheres Handelsvolumen während der Bildung eines Hammer erhöht die Zuverlässigkeit des Signals.
