...
Ein dünnes Orderbuch ist eine Darstellung des Orderbuchs, die alle möglichen Preisniveaus anzeigt, einschließlich solcher, auf denen aktuell keine aktiven Orders vorhanden sind. Dieser Ansatz ermöglicht Tradern, die "Lücken" zwischen Orders visuell zu bewerten, also Preisniveaus ohne Kauf- oder Verkaufsorders, und gibt Einblick in mögliche Widerstands- oder Unterstützungsniveaus.

## Warum ein dünnes Orderbuch verwenden

Die Verwendung eines dünnen Orderbuchs hat mehrere Vorteile:
...
## Erstellen eines dünnen Orderbuchs
