...
- **ZeroAsNull** - ob numerische Nullwerte als `null` interpretiert werden sollen.
...
Unterstützte Datentypen: Ticks, Kerzen, Orderbücher, Level1, Orderprotokoll, Transaktionen, Instrumente, Nachrichten und Positionen.
