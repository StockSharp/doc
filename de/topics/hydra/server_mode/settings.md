...
[Hydra](../../hydra.md) kann im Servermodus verwendet werden. In diesem Modus können Sie sich remote mit [Hydra](../../hydra.md) verbinden und vorhandene Daten aus dem Speicher abrufen. Sie können sich aus dem [Designer](../../designer.md) mit [Hydra](../../hydra.md) im Servermodus verbinden (siehe [Erste Schritte](../../designer/market_data_storage/getting_started.md) in der Dokumentation von [Designer](../../designer.md)). Sie können auch über die [API](../../api.md) eine Verbindung zu [Hydra](../../hydra.md) herstellen (Details finden Sie im Abschnitt [FIX/FAST-Konnektivität](fix_fast_connectivity.md)).
...
![Einstellungen Bildschirmfoto 1](../../../images/hydra_server_menu.png)

Klicken Sie danach auf die Schaltfläche **Einstellungen**, um das Einstellungsfenster für den Servermodus zu öffnen.

![Einstellungen Bildschirmfoto 2](../../../images/hydra_server.png)
...
- **Orderbücher (Tage)** - die maximale Anzahl von Tagen, die zum Herunterladen der Orderbuchhistorie verfügbar ist.
...
![Einstellungen Bildschirmfoto 3](../../../images/hydra_users.png)
