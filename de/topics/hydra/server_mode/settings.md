...
- **FIX-Server** - [Hydra](../../hydra.md) in den Servermodus schalten, der Live-Handelsdaten und historische Daten über das FIX-Protokoll verteilt.
  ...
  3. **TransactionSession** - Einstellung einer Handelssitzung. Einrichtung für den Handel über das Programm [Hydra](../../hydra.md).
     ...
     Mit dieser Einstellung können Sie Dialect des FIX-Protokolls, Sender und Recipient, Datenformat und weitere Einstellungen konfigurieren. Details finden Sie unter [FIXServer-Eigenschaften](https://doc.stocksharp.ru/html/Properties_T_StockSharp_Fix_FixServer.htm).
