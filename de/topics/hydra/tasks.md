...
Um die Liste der Werkzeuge anzuzeigen, wählen Sie im linken Panel den Eintrag **Werkzeuge** aus. Die Arbeit mit Werkzeugen erfolgt genauso wie mit Quellen: Das Werkzeug kann hinzugefügt, gelöscht, bearbeitet sowie aktiviert\/deaktiviert werden. Um das **Werkzeug** hinzuzufügen, wählen Sie auf der Registerkarte **Allgemein** den Punkt **Hinzufügen \=\> Werkzeuge**. Es erscheint ein entsprechendes Fenster, in dem Sie das erforderliche **Werkzeug** auswählen können...

![Aufgaben Screenshot](../../images/hydra_tasks.png)
