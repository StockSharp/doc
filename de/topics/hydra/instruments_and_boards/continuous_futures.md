...
2. Um einen fortlaufenden Future zu erstellen, müssen Sie einen Namen angeben und Kontrakte hinzufügen.
   ...
   - Manuell durch Klicken auf die Schaltfläche ![Hydra Schaltfläche Hinzufügen](../../../images/hydra_add.png).![HydraGluingCSCustom](../../../images/hydragluingcscustom.png)
...
5. Klicken Sie danach auf der Registerkarte **Allgemein** auf die Schaltfläche [Kerzen](../working_with_data/view_and_export/candles.md), wählen Sie das resultierende Instrument und den Datenzeitraum aus, setzen Sie im Feld **Erstellen aus** den Wert **Zusammengesetztes Element** und klicken Sie dann auf die Schaltfläche ![Hydra Suchschaltfläche](../../../images/hydra_find.png). ![HydraGluingTrades](../../../images/hydragluingtrades.png)
