...
2. Importparameter für [S#](../../api.md)-Felder konfigurieren.
   ...
   - **Standardmäßig** - Standardwert des Feldes. Er kann zum Beispiel für wiederholte Feldwerte verwendet werden (**Instrument** oder **Handelsplatz** beim Import von Trades, Order Books usw., siehe [Trades](ticks.md)), wenn die entsprechende Information in der Datendatei fehlt.
