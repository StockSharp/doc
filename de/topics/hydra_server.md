...
> [!TIP]
> Unter Windows kann Hydra Server als Windows-Dienst registriert und beim Systemstart automatisch gestartet werden. Weitere Informationen finden Sie unter [Windows-Dienst](https://en.wikipedia.org/wiki/Windows_service).
...
- **CompanyPath** - wenn das Programm als Windows-Dienst verwendet wird, muss ein Pfad wie "C:\\Users\\%user_name%\\Documents\\StockSharp" angegeben werden.
